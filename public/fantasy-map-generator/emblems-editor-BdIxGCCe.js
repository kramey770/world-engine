import{C as e,Et as t,J as n,S as r,dn as i,k as a}from"./utils-BXw8fBj4.js";import{A as o,E as s,j as c}from"./layers-_nptVsMl.js";import{t as l}from"./drag-BxIG-06a.js";import{n as u}from"./highlight-jHumwiM5.js";import{r as d,t as f}from"./tooltips-0xeyl30m.js";import{r as p}from"./dialog-helpers-DT2MP2B1.js";import{t as m}from"./emblems-generator-Bvd9Hj5Y.js";var h,g,_,v;async function y(){let e=pack.states.find(e=>e.i&&!e.removed&&e.coa),t=pack.burgs.find(e=>e.i&&!e.removed&&e.coa),n=e?`state`:`burg`,r=e??t;if(!r?.coa){d(`No emblems to edit, please generate states and burgs first`,!1,`error`);return}let i=`${n}COA${r.i}`;await c.trigger(i,r.coa),b(n,i,r)}function b(e,t,n,r){if(!customization){if(!t&&r)S(r);else{if(!e||!t||!n?.coa)return;h=e,g=t,_=n}x(),q(),v?.(),v=o(q),C(),$(`#emblemEditor`).dialog({title:`Edit Emblem`,resizable:!0,width:`18.2em`,height:`auto`,position:{my:`left top`,at:`left+10 top+10`,of:`svg`,collision:`fit`},close:J})}}function x(){p(`emblemEditor`),a(`dialogs`).insertAdjacentHTML(`beforeend`,`<div id="emblemEditor" class="dialog stable">
    ...
    </div>`),a(`emblemStates`).oninput=T,a(`emblemProvinces`).oninput=E,a(`emblemBurgs`).oninput=D,a(`emblemShapeSelector`).oninput=O,a(`emblemSizeSlider`).oninput=A,a(`emblemSizeNumber`).oninput=A,a(`emblemsRegenerate`).onclick=j,a(`emblemsArmoria`).onclick=M,a(`emblemsUpload`).onclick=N,a(`emblemsUploadImage`).onclick=()=>a(`emblemImageToLoad`).click(),a(`emblemsUploadSVG`).onclick=()=>a(`emblemSVGToLoad`).click(),a(`emblemImageToLoad`).onchange=()=>P(`image`),a(`emblemSVGToLoad`).onchange=()=>P(`svg`),a(`emblemsDownload`).onclick=F,a(`emblemsDownloadSVG`).onclick=()=>I(`svg`),a(`emblemsDownloadPNG`).onclick=()=>I(`png`),a(`emblemsDownloadJPG`).onclick=()=>I(`jpeg`),a(`emblemsGallery`).onclick=V,a(`emblemsFocus`).onclick=k}function S(e){let t=e.parentNode,n=t.id===`burgEmblems`?`burg`:t.id===`provinceEmblems`?`province`:`state`,r=+e.dataset.i,i=G(n,r);if(!i)throw Error(`Cannot edit ${n} emblem ${r}`);h=n,g=`${h}COA${r}`,_=i}function C(){let e=h,t=_,n=a(`emblemStates`),r=a(`emblemProvinces`),i=a(`emblemBurgs`),o=0,s=0,l=0;n.parentElement.className=e===`state`?`active`:``,r.parentElement.className=e===`province`?`active`:``,i.parentElement.className=e===`burg`?`active`:``,e===`state`?o=t.i:e===`province`?(s=t.i,o=pack.states[t.state].i):(l=t.i,s=pack.cells.province[t.cell]?pack.provinces[pack.cells.province[t.cell]].i:0,o=t.state??0);let u=pack.burgs.filter(e=>e.i&&!e.removed&&e.coa);n.options.length=0,u.filter(e=>!e.state).length&&n.options.add(new Option(pack.states[0].name,`0`,!1,!o)),pack.states.filter(e=>e.i&&!e.removed).forEach(e=>{n.options.add(new Option(e.name,String(e.i),!1,e.i===o))}),r.options.length=0,r.options.add(new Option(``,`0`,!1,!s)),pack.provinces.filter(e=>!e.removed&&e.state===o).forEach(e=>{r.options.add(new Option(e.name,String(e.i),!1,e.i===s))}),i.options.length=0,i.options.add(new Option(``,`0`,!1,!l)),u.filter(e=>s?pack.cells.province[e.cell]===s:e.state===o).forEach(e=>{i.options.add(new Option(e.capital?`👑 ${e.name}`:e.name,String(e.i),!1,e.i===l))}),i.options[0].disabled=!0,c.trigger(g,t.coa),w()}function w(){let e=_;if(!e.coa)return;a(`emblemImage`).setAttribute(`href`,`#${g}`);let t=e.fullName||e.name;h===`burg`&&(t=`Burg of ${t}`),a(`emblemArmiger`).innerText=t??``;let n=a(`emblemShapeSelector`);e.coa.custom?n.disabled=!0:(n.disabled=!1,n.value=e.coa.shield??`heater`);let r=e.coa.size??1;a(`emblemSizeSlider`).value=String(r),a(`emblemSizeNumber`).value=String(r)}function T(){let e=+a(`emblemStates`).value;if(e){if(!K(`state`,e))return}else{let e=pack.burgs.filter(e=>e.i&&!e.removed&&!e.state);if(!e.length||!K(`burg`,e[0].i))return}C()}function E(){let e=+a(`emblemProvinces`).value;if(e){if(!K(`province`,e))return}else if(!K(`state`,+a(`emblemStates`).value))return;C()}function D(){K(`burg`,+a(`emblemBurgs`).value)&&C()}function O(){_.coa.shield=a(`emblemShapeSelector`).value;let e=document.getElementById(g);e&&e.remove(),c.trigger(g,_.coa)}function k(){u(h,_)}function A(e){let t=+e.currentTarget.value;a(`emblemSizeSlider`).value=String(t),a(`emblemSizeNumber`).value=String(t),_.coa.size=t,s(h,_.i)}function j(){let e=_,t;if(h===`province`)t=pack.states[e.state];else if(h===`burg`){let n=pack.cells.province[e.cell];t=n?pack.provinces[n]:pack.states[e.state]}let n=e.coa.shield||m.getShield(e.culture||t?.culture||0,e.state),{size:r,x:i,y:o}=e.coa;e.coa={...m.generate(t?t.coa:null,.3,.1,void 0),shield:n,size:r,x:i,y:o};let l=a(`emblemShapeSelector`);l.disabled=!1,l.value=e.coa.shield??`heater`,c.trigger(g,e.coa),s(h,_.i)}function M(){let e=_.coa&&!_.coa.custom?_.coa:{t1:`sable`},t=`https://azgaar.github.io/Armoria/?coa=${JSON.stringify(e).replaceAll(`#`,`%23`)}&from=FMG`;n(t)}function N(){a(`emblemDownloadControl`).classList.add(`hidden`),a(`emblemUploadControl`).classList.toggle(`hidden`)}function P(e){let t=_,n=a(e===`image`?`emblemImageToLoad`:`emblemSVGToLoad`),r=n.files[0];if(n.value=``,r.size>5e5){d(`File is too big, please optimize file size up to 500kB and re-upload. Recommended size is 200x200 px and up to 100kB`,!0,`error`,5e3);return}let i=new FileReader;i.onload=n=>{let r=n.target.result,i=a(`defs-emblems`),o=r;if(e===`svg`){let e=document.createElement(`html`);e.innerHTML=r,e.querySelectorAll(`*`).forEach(e=>{e.id===`adobe_illustrator_pgf`&&e.remove(),e.getAttributeNames().forEach(t=>{(t.includes(`inkscape`)||t.includes(`sodipodi`))&&e.removeAttribute(t)})});let t=e.querySelector(`svg`);if(!t){d(`The file is not a valid SVG. Please use Armoria or other relevant tools`,!1,`error`);return}let n=new XMLSerializer().serializeToString(t);o=`data:image/svg+xml;base64,${window.btoa(n)}`}let l=`<svg id="${g}" viewBox="0 0 200 200"><image width="200" height="200" href="${o}"/></svg>`;c.remove(g),i.insertAdjacentHTML(`beforeend`,l);let u={custom:!0};t.coa.size!==void 0&&(u.size=t.coa.size),t.coa.x!==void 0&&(u.x=t.coa.x),t.coa.y!==void 0&&(u.y=t.coa.y),t.coa=u,s(h,_.i),a(`emblemShapeSelector`).disabled=!0},e===`image`?i.readAsDataURL(r):i.readAsText(r)}function F(){a(`emblemUploadControl`).classList.add(`hidden`),a(`emblemDownloadControl`).classList.toggle(`hidden`)}async function I(t){let n=document.getElementById(g),r=+a(`emblemsDownloadSize`).value,i=await z(n,r),o=document.createElement(`a`);o.download=`${e(`Emblem ${_.fullName||_.name}`)}.${t}`,t===`svg`?L(i,o):R(t,i,o,r),a(`emblemDownloadControl`).classList.add(`hidden`)}function L(e,t){t.href=e,t.click()}function R(e,t,n,r){let i=document.createElement(`canvas`),a=i.getContext(`2d`);i.width=r,i.height=r;let o=new Image;o.src=t,o.onload=()=>{e===`jpeg`&&(a.fillStyle=`#fff`,a.fillRect(0,0,i.width,i.height)),a.drawImage(o,0,0,i.width,i.height);let t=i.toDataURL(`image/${e}`,.92);n.href=t,n.click(),window.setTimeout(()=>window.URL.revokeObjectURL(t),6e3)}}async function z(e,t){let n=B(e,t),r=new Blob([n],{type:`image/svg+xml;charset=utf-8`}),i=window.URL.createObjectURL(r);return window.setTimeout(()=>window.URL.revokeObjectURL(i),6e3),i}function B(e,t){let n=e.cloneNode(!0);return n.setAttribute(`width`,String(t)),n.setAttribute(`height`,String(t)),new XMLSerializer().serializeToString(n)}async function V(){let t=e(`Emblems Gallery`),n=pack.states.filter(e=>e.i&&!e.removed&&e.coa),i=pack.provinces.filter(e=>e.i&&!e.removed&&e.coa),a=pack.burgs.filter(e=>e.i&&!e.removed&&e.coa);await H(n,i,a);let o=`<a href="javascript:history.back()">Go Back</a>`,s=`<div><h2>States</h2>${n.map(e=>{let t=document.getElementById(`stateCOA${e.i}`);return`<figure id="state_${e.i}"><a href="#provinces_${e.i}"><figcaption>${e.fullName}</figcaption>${B(t,200)}</a></figure>`}).join(``)}</div>`,c=n.map(e=>{let t=i.filter(t=>t.state===e.i),n=t.map(e=>{let t=document.getElementById(`provinceCOA${e.i}`);return`<figure id="province_${e.i}"><a href="#burgs_${e.i}"><figcaption>${e.fullName}</figcaption>${B(t,200)}</a></figure>`}).join(``);return t.length?`<div id="provinces_${e.i}">${o}<h2>${e.fullName} provinces</h2>${n}</div>`:``}).join(``),l=n.map(e=>{let t=a.filter(t=>t.state===e.i),n=i.filter(t=>t.state===e.i).map(e=>{let n=t.filter(t=>pack.cells.province[t.cell]===e.i),r=n.map(e=>{let t=document.getElementById(`burgCOA${e.i}`);return t?`<figure id="burg_${e.i}"><figcaption>${e.name}</figcaption>${B(t,200)}</figure>`:``}).join(``);return n.length?`<div id="burgs_${e.i}">${o}<h2>${e.fullName} burgs</h2>${r}</div>`:``}).join(``),r=t.filter(e=>!pack.cells.province[e.cell]).map(e=>{let t=document.getElementById(`burgCOA${e.i}`);return t?`<figure id="burg_${e.i}"><figcaption>${e.name}</figcaption>${B(t,200)}</figure>`:``}).join(``);return r&&(n+=`<div><h2>${e.fullName} burgs under direct control</h2>${r}</div>`),n}).join(``),u=a.filter(e=>!e.state),d=u.length?`<div><h2>Independent burgs</h2>${u.map(e=>{let t=document.getElementById(`burgCOA${e.i}`);return t?`<figure id="burg_${e.i}"><figcaption>${e.name}</figcaption>${B(t,200)}</figure>`:``}).join(``)}</div>`:``,f=`<!DOCTYPE html>
    <html>
      <head>
    ...
    </html>`;r(f,`${t}.html`,`text/plain`)}async function H(e,t,n){d(`Preparing for download...`,!0,`warn`);let r=e.map(e=>c.trigger(`stateCOA${e.i}`,e.coa)),i=t.map(e=>c.trigger(`provinceCOA${e.i}`,e.coa)),a=n.map(e=>c.trigger(`burgCOA${e.i}`,e.coa)),o=[...r,...i,...a];await Promise.allSettled(o),f()}function U(e){let n=Number(this.getAttribute(`x`))-e.x,r=Number(this.getAttribute(`y`))-e.y;e.on(`drag`,function(e){this.setAttribute(`x`,String(n+e.x)),this.setAttribute(`y`,String(r+e.y))}),e.on(`end`,function(e){let i=Number(this.parentNode.getAttribute(`font-size`))*Number.parseFloat(this.getAttribute(`width`)||`1`)/2,a=W(this.parentElement?.id),o=Number(this.dataset.i),c=a&&Number.isInteger(o)?G(a,o):void 0;a&&c&&(c.coa.x=t(n+e.x+i,2),c.coa.y=t(r+e.y+i,2),s(a,o))})}function W(e){if(e===`burgEmblems`)return`burg`;if(e===`provinceEmblems`)return`province`;if(e===`stateEmblems`)return`state`}function G(e,t){let n=e===`burg`?pack.burgs[t]:e===`province`?pack.provinces[t]:pack.states[t];return n?.coa?n:void 0}function K(e,t){let n=G(e,t);return n?(h=e,g=`${e}COA${t}`,_=n,!0):!1}function q(){i(`#emblems`).selectAll(`use`).call(l().on(`drag`,U)).classed(`draggable`,!0)}function J(){v?.(),v=void 0,i(`#emblems`).selectAll(`use`).on(`.drag`,null).attr(`class`,null),$(`#emblemEditor`).dialog(`destroy`),a(`emblemEditor`).remove()}var Y={open:b,openDefault:y};export{Y as EmblemsEditor};