import{C as e,E as t,Et as n,J as r,S as i,X as a,_n as o,gn as s,k as c,wn as l}from"./utils-BIleyWmR.js";import{t as u}from"./median-DZTflNey.js";import{t as d}from"./mean-4Awewi9R.js";import{r as f}from"./tooltips-zkair8Am.js";import{r as p,t as m}from"./dialog-helpers-50LJgx0U.js";function h(){customization||(m(`#namesbaseEditor, .stable`),g(),v(),y(),$(`#namesbaseEditor`).dialog({title:`Namesbase Editor`,width:`60vw`,position:{my:`center`,at:`center`,of:`svg`},close:_}))}function g(){p(`namesbaseEditor`),c(`dialogs`).insertAdjacentHTML(`beforeend`,`<div id="namesbaseEditor" class="dialog stable textual">
      ...
      <hr />
      <div data-tip="The shortest name length">Min name length: ${s(m)}</div>
      <div data-tip="The longest name length">Max name length: ${o(m)}</div>
      <div data-tip="Average name length">Mean name length: ${n(d(m)??0,1)}</div>
      ...
      <div data-tip="Percentage of names containing space character">Multi-word names: ${n(b*100,2)}%</div>
