import{A as e,Bt as t,C as n,Cn as r,D as i,Gt as a,M as o,S as s,Tt as c,Wt as l,X as u,Zt as d,d as f,dt as p,i as m,it as h,k as g,r as _,un as v,yt as y}from"./utils-omhVlsRt.js";import{D as b,E as x,O as S,j as C,n as w,r as T,t as E}from"./layers-DHltDypB.js";import{t as D}from"./sin-DXK16t1M.js";import{t as O}from"./highlight-D0bzltDC.js";import{r as ee,t as te}from"./stratify-CGdiYggi.js";import{n as k,t as A}from"./constant-CUk6ox2a.js";import{t as ne}from"./heightUtils-BfaaFPbS.js";import{r as j,t as re}from"./tooltips-BQ3W48fB.js";import{a as M,n as N,r as P,t as F}from"./dialog-helpers-CdcIkxap.js";import{t as I}from"./emblems-generator-BN5o8bHo.js";import{t as L}from"./state-CHxunpWe.js";import{P as R,b as ie,j as ae,y as oe}from"./index-DWZM8gkY.js";import{t as se}from"./highlighting-D_bHr-1Y.js";import{i as ce,n as le,r as ue,t as de}from"./table-DM0fGDYA.js";function fe(e){e.x0=Math.round(e.x0),e.y0=Math.round(e.y0),e.x1=Math.round(e.x1),e.y1=Math.round(e.y1)}function pe(e,t,n,r,i){for(var a=e.children,o,s=-1,c=a.length,l=e.value&&(r-t)/e.value;++s<c;)o=a[s],o.y0=n,o.y1=i,o.x0=t,o.x1=t+=o.value*l}function me(e,t,n,r,i){for(var a=e.children,o,s=-1,c=a.length,l=e.value&&(i-n)/e.value;++s<c;)o=a[s],o.x0=t,o.x1=r,o.y0=n,o.y1=n+=o.value*l}var he=(1+Math.sqrt(5))/2;function ge(e,t,n,r,i,a){for(var o=[],s=t.children,c,l,u=0,d=0,f=s.length,p,m,h=t.value,g,_,v,y,b,x,S;u<f;){p=i-n,m=a-r;do g=s[d++].value;while(!g&&d<f);for(_=v=g,x=Math.max(m/p,p/m)/(h*e),S=g*g*x,b=Math.max(v/S,S/_);d<f;++d){if(g+=l=s[d].value,l<_&&(_=l),l>v&&(v=l),S=g*g*x,y=Math.max(v/S,S/_),y>b){g-=l;break}b=y}o.push(c={value:g,dice:p<m,children:s.slice(u,d)}),c.dice?pe(c,n,r,i,h?r+=m*g/h:a):me(c,n,r,h?n+=p*g/h:i,a),h-=g,u=d}return o}var _e=(function e(t){function n(e,n,r,i,a){ge(t,e,n,r,i,a)}return n.ratio=function(t){return e((t=+t)>1?t:1)},n})(he);function ve(){var e=_e,t=!1,n=1,r=1,i=[0],a=A,o=A,s=A,c=A,l=A;function u(e){return e.x0=e.y0=0,e.x1=n,e.y1=r,e.eachBefore(d),i=[0],t&&e.eachBefore(fe),e}function d(t){var n=i[t.depth],r=t.x0+n,u=t.y0+n,d=t.x1-n,f=t.y1-n;d<r&&(r=d=(r+d)/2),f<u&&(u=f=(u+f)/2),t.x0=r,t.y0=u,t.x1=d,t.y1=f,t.children&&(n=i[t.depth+1]=a(t)/2,r+=l(t)-n,u+=o(t)-n,d-=s(t)-n,f-=c(t)-n,d<r&&(r=d=(r+d)/2),f<u&&(u=f=(u+f)/2),e(t,r,u,d,f))}return u.round=function(e){return arguments.length?(t=!!e,u):t},u.size=function(e){return arguments.length?(n=+e[0],r=+e[1],u):[n,r]},u.tile=function(t){return arguments.length?(e=ee(t),u):e},u.padding=function(e){return arguments.length?u.paddingInner(e).paddingOuter(e):u.paddingInner()},u.paddingInner=function(e){return arguments.length?(a=typeof e==`function`?e:k(+e),u):a},u.paddingOuter=function(e){return arguments.length?u.paddingTop(e).paddingRight(e).paddingBottom(e).paddingLeft(e):u.paddingTop()},u.paddingTop=function(e){return arguments.length?(o=typeof e==`function`?e:k(+e),u):o},u.paddingRight=function(e){return arguments.length?(s=typeof e==`function`?e:k(+e),u):s},u.paddingBottom=function(e){return arguments.length?(c=typeof e==`function`?e:k(+e),u):c},u.paddingLeft=function(e){return arguments.length?(l=typeof e==`function`?e:k(+e),u):l},u}var z=`provincesEditor`,B={my:`right top`,at:`right-10 top+10`,of:`svg`,collision:`fit`},V,H=e=>_(e.area),U=e=>c(e.rural*populationRate+e.urban*populationRate*urbanization),W=[{key:`color`,width:`1.2em`,permanent:!0},{key:`name`,label:`Province`,width:`7em`,permanent:!0,sortBy:e=>e.name||``,sortType:`alpha`},{key:`emblem`,width:`1.4em`},{key:`form`,label:`Form`,width:`7em`,mobileHidden:!0,sortBy:e=>e.formName||``,sortType:`alpha`},{key:`capital`,label:`Capital`,width:`7em`,sortBy:e=>e.burg&&pack.burgs[e.burg]?.name||``,sortType:`alpha`},{key:`state`,label:`State`,width:`7em`,permanent:!0,sortBy:e=>pack.states[e.state]?.name||``,sortType:`alpha`},{key:`burgs`,label:`Burgs`,width:`5em`,mobileHidden:!0,sortBy:e=>e.burgs?.length||0},{key:`area`,label:`Area`,width:`7em`,mobileHidden:!0,defaultSort:`desc`,sortBy:H},{key:`population`,label:`Population`,width:`6em`,sortBy:U},{key:`actions`,width:`5.4em`,permanent:!0,align:`right`}],G=le({getData:Y,onUpdate:xe});function K(){customization||(V=L.get(z,`filters`,()=>({stateId:1})),F(`#provincesEditor, .stable`),E.show(`provinces`,`borders`),E.hide(`states`,`cultures`),ye(),q(),$(`#provincesEditor`).dialog({title:`Provinces Editor`,resizable:!1,width:fitContent(),close:Xe,position:B}))}function ye(){P(`provincesEditor`);let e=`<div id="provincesEditor" class="dialog stable editorDialog">
    ...
    </div>`;g(`dialogs`).insertAdjacentHTML(`beforeend`,e),oe(z,G.reset),de({dialogId:z,columns:W,onUpdate:()=>M(z,{width:`fit-content`,position:B})}),se(`provincesEditor`,({cellId:e})=>pack.cells.province[e]),g(`provincesEditorRefresh`).addEventListener(`click`,q),g(`provincesEditStyle`).addEventListener(`click`,()=>editStyle(`provs`)),g(`provincesFilterState`).addEventListener(`change`,e=>{V.stateId=+e.target.value,L.set(z,`filters`,V),G.reset()}),g(`provincesPercentage`).addEventListener(`click`,Be),g(`provincesChart`).addEventListener(`click`,Ve),g(`provincesExport`).addEventListener(`click`,Je),g(`provincesRemoveAll`).addEventListener(`click`,Ye),g(`provincesManually`).addEventListener(`click`,Ue),g(`provincesRelease`).addEventListener(`click`,He),g(`provincesAdd`).addEventListener(`click`,Ge),g(`provincesMerge`).addEventListener(`click`,Ze),g(`provincesRecolor`).addEventListener(`click`,qe),g(`provincesBodySection`).addEventListener(`click`,e=>{if(customization)return;let t=e.target,n=t.classList,r=t.closest(`.states`);if(!r)return;let i=+r.dataset.id,a=pack.provinces[i].state;t.tagName===`FILL-BOX`?Ce(t):n.contains(`name`)?je(i):n.contains(`coaIcon`)?R.EmblemsEditor.open(`province`,`provinceCOA${i}`,pack.provinces[i]):n.contains(`icon-star-empty`)?we(i):n.contains(`icon-flag-empty`)?Te(i):n.contains(`icon-dot-circled`)?R.BurgsOverview.open({stateId:a}):n.contains(`culturePopulation`)?Oe(i):n.contains(`icon-target`)?O(v(`#provs`).select(`#province${i}`).node(),8):n.contains(`icon-pin`)?ke(i,n):n.contains(`icon-trash-empty`)?Ae(i):(n.contains(`icon-lock`)||n.contains(`icon-lock-open`))&&tt(i,n)}),g(`provincesBodySection`).addEventListener(`change`,e=>{let t=e.target,n=t.classList,r=t.closest(`.states`);if(!r)return;let i=+r.dataset.id;n.contains(`cultureBase`)&&ze(i,r,t.value)})}function q(){J(),be(),G.reset()}function J(){let{cells:e,provinces:t,burgs:n}=pack;t.forEach(e=>{e.i&&!e.removed&&(e.area=e.rural=e.urban=0,e.burgs=[],(e.burg&&!n[e.burg]||n[e.burg]?.removed)&&(e.burg=0))});for(let n of e.i){let r=e.province[n];r&&(t[r].area+=e.area[n],t[r].rural+=e.pop[n])}for(let r of n){if(!r.i||r.removed||r.flying)continue;let n=e.province[r.cell];n&&(t[n].urban+=r.population??0,t[n].burgs.push(r.i))}t.forEach(e=>{e.i&&!e.removed&&!e.burg&&e.burgs.length&&(e.burg=e.burgs[0])})}function be(){let e=g(`provincesFilterState`);V.stateId!==-1&&!pack.states.some(e=>e.i===V.stateId&&!e.removed)&&(V.stateId=-1),e.options.length=0,e.options.add(new Option(`all`,`-1`,!1,V.stateId===-1)),pack.states.filter(e=>e.i&&!e.removed).sort((e,t)=>e.name>t.name?1:-1).forEach(t=>{e.options.add(new Option(t.name,String(t.i),!1,t.i===V.stateId))}),L.set(z,`filters`,V)}function Y(){let e=pack.provinces.filter(e=>e.i&&!e.removed),t=V.stateId===-1?e:e.filter(e=>e.state===V.stateId);return ie(z,t,W)}function xe(e){let t=g(`provincesBodySection`),n=` ${m()}`,r=e.all.reduce((e,t)=>({area:e.area+H(t),population:e.population+U(t),burgs:e.burgs+t.burgs.length}),{area:0,population:0,burgs:0}),i=t.dataset.type===`percentage`,a=e.rows.map(e=>{let t=H(e),a=e.rural*populationRate,o=e.urban*populationRate*urbanization,s=U(e),l=`Total population: ${f(s)}; Rural population: ${f(a)}; Urban population: ${f(o)}`,u=pack.states[e.state].name,d=e.burg&&e.burg!==pack.states[e.state].capital,p=v(`#deftemp`).select(`#fog #focusProvince${e.i}`).size();return C.trigger(`provinceCOA${e.i}`,e.coa),`<div class="states" data-id=${e.i}>
    ...
    </div>`),g(`provinceNameEditorShortCulture`).addEventListener(`click`,Pe),g(`provinceNameEditorShortRandom`).addEventListener(`click`,Fe),g(`provinceNameEditorShortSpeak`).addEventListener(`click`,()=>u(g(`provinceNameEditorShort`).value)),g(`provinceNameEditorAddForm`).addEventListener(`click`,Ie),g(`provinceNameEditorFullRegenerate`).addEventListener(`click`,Le),g(`provinceNameEditorFullSpeak`).addEventListener(`click`,()=>u(g(`provinceNameEditorFull`).value))}function Ne(){$(`#provinceNameEditor`).dialog(`destroy`),g(`provinceNameEditor`).remove()}function Pe(){let e=+g(`provinceNameEditor`).dataset.province,t=pack.cells.culture[pack.provinces[e].center],n=Names.getState(Names.getCultureShort(t),t);g(`provinceNameEditorShort`).value=n}function Fe(){let e=y(Names.nameBases.length-1),t=Names.getState(Names.getBase(e),void 0,e);g(`provinceNameEditorShort`).value=t}function Ie(){let e=g(`provinceNameEditorCustomForm`),t=g(`provinceNameEditorSelectForm`),n=e.value,r=e.style.display===`inline-block`;e.style.display=r?`none`:`inline-block`,t.style.display=r?`inline-block`:`none`,r&&i(t,n)}function Le(){let e=g(`provinceNameEditorShort`).value,t=g(`provinceNameEditorSelectForm`).value,n=()=>t?!e&&t?`The ${t}`:`${e} ${t}`:e;g(`provinceNameEditorFull`).value=n()}function Re(e){e.name=g(`provinceNameEditorShort`).value,e.formName=g(`provinceNameEditorSelectForm`).value,e.fullName=g(`provinceNameEditorFull`).value,E.draw(`provinces`),E.draw(`labels`),q()}function ze(e,t,n){t.dataset.capital=pack.burgs[+n].name,pack.provinces[e].center=pack.burgs[+n].cell,pack.provinces[e].burg=+n}function Be(){let e=g(`provincesBodySection`);e.dataset.type=e.dataset.type===`absolute`?`percentage`:`absolute`,G.refresh()}function Ve(){let e=e=>!e.i||e.removed||e.color[0]!==`#`?`#666`:String(d(e.color).darker()),t=pack.states.map(t=>({id:t.i,state:t.i?0:null,color:e(t)})),n=pack.provinces.filter(e=>e.i&&!e.removed).map(e=>({id:e.i+t.length-1,i:e.i,state:e.state,color:e.color,name:e.name,fullName:e.fullName,area:e.area,urban:e.urban,rural:e.rural})),r=[...t,...n],i=te().parentId(e=>e.state)(r).sum(e=>e.area),a=+g(`uiSize`).value,o=300+300*a,s=90+90*a,l={top:10,right:10,bottom:0,left:10},u=o-l.left-l.right,p=s-l.top-l.bottom,h=ve().size([u,p]).padding(2);alertMessage.innerHTML=`<select id="provincesTreeType" style="display:block; margin-left:13px; font-size:11px">
    <option value="area" selected>Area</option>
    <option value="population">Total population</option>
    <option value="rural">Rural population</option>
    <option value="urban">Urban population</option>
  </select>`,alertMessage.innerHTML+=`<div id='provinceInfo' class='chartInfo'>&#8205;</div>`;let y=v(`#alertMessage`).insert(`svg`,`#provinceInfo`).attr(`id`,`provincesTree`).attr(`width`,o).attr(`height`,s).attr(`font-size`,`10px`).append(`g`).attr(`transform`,`translate(10, 0)`);g(`provincesTreeType`).addEventListener(`change`,w),h(i);let b=y.selectAll(`g`).data(i.leaves()).enter().append(`g`).attr(`data-id`,e=>e.data.i).on(`mouseenter`,(e,t)=>x(e,t)).on(`mouseleave`,e=>S(e));function x(e,t){v(e.currentTarget).select(`rect`).classed(`selected`,!0);let n=t.data.fullName,r=pack.states[t.data.state].fullName,i=`${_(t.data.area)} ${m()}`,a=c(t.data.rural*populationRate),o=c(t.data.urban*populationRate*urbanization),s=g(`provincesTreeType`).value,l=s===`area`?`Area: ${i}`:s===`rural`?`Rural population: ${f(a)}`:s===`urban`?`Urban population: ${f(o)}`:`Population: ${f(a+o)}`;g(`provinceInfo`).innerHTML=`${n}. ${r}. ${l}`,X(e)}function S(e){Z(e),document.getElementById(`provinceInfo`)&&(g(`provinceInfo`).innerHTML=`&#8205;`,v(e.currentTarget).select(`rect`).classed(`selected`,!1))}b.append(`rect`).attr(`stroke`,e=>e.parent.data.color).attr(`stroke-width`,1).attr(`fill`,e=>e.data.color).attr(`x`,e=>e.x0).attr(`y`,e=>e.y0).attr(`width`,e=>e.x1-e.x0).attr(`height`,e=>e.y1-e.y0),b.append(`text`).attr(`text-rendering`,`optimizeSpeed`).attr(`dx`,`.2em`).attr(`dy`,`1em`).attr(`x`,e=>e.x0).attr(`y`,e=>e.y0);function C(){b.select(`text`).each(function(e){this.innerHTML=e.data.name;let t=this.getBBox();t.y+t.height>e.y1+1&&(this.innerHTML=``);for(let n=0;n<15&&t.width>0&&t.x+t.width>e.x1;n++){if(this.innerHTML.length<3){this.innerHTML=``;break}this.innerHTML=`${this.innerHTML.slice(0,-2)}…`,t=this.getBBox()}})}function w(){let e=this.value===`area`?e=>e.area:this.value===`rural`?e=>e.rural:this.value===`urban`?e=>e.urban:e=>e.rural+e.urban;i.sum(e),b.data(h(i).leaves()),b.select(`rect`).transition().duration(1500).attr(`x`,e=>e.x0).attr(`y`,e=>e.y0).attr(`width`,e=>e.x1-e.x0).attr(`height`,e=>e.y1-e.y0),b.select(`text`).transition().duration(1500).attr(`x`,e=>e.x0).attr(`y`,e=>e.y0),setTimeout(C,2e3)}$(`#alert`).dialog({title:`Provinces chart`,width:fitContent(),position:{my:`left bottom`,at:`left+10 bottom-10`,of:`svg`},buttons:{},close:()=>{alertMessage.innerHTML=``}}),C()}function He(){N({title:`Release provinces`,message:`Are you sure you want to release all provinces?
        </br>It will turn all separable provinces into independent states.
        </br>Capital province and provinces without any burgs will state as they are`,confirm:`Release`,onConfirm:()=>{let e=[],t=[];Y().forEach(n=>{if(!n.burg||n.burg===pack.states[n.state].capital||n.burgs.some(e=>pack.burgs[e].capital))return;let r=Ee(n.i);r&&(e.push(r[0]),t.push(r[1]))}),De(r(e),t)}})}function Ue(){E.show(`provinces`,`borders`),R.PaintEditor.open({title:`Paint Provinces`,parentDialogId:z,onClose:K,items:Y().map(e=>({id:e.i,name:e.name,color:e.color||`#ffffff`})),getValue:e=>pack.cells.province[e],filterCell:(e,t,n)=>!ne(e,pack)||!pack.cells.state[e]||pack.cells.state[e]!==pack.provinces[n].state?!1:!t||e!==pack.provinces[t].center||(j(`Province center cannot be assigned to a different region. Please remove the province first`,!1,`error`),!1),dontOverrideControl:!0,onApply:We})}function We(e){for(let[t,n]of e)pack.cells.province[t]=n;Provinces.getPoles(),E.draw(`borders`,`provinces`),E.draw(`labels`),document.getElementById(z)&&q()}function Ge(){if(this.classList.contains(`pressed`)){Q();return}customization=12,this.classList.add(`pressed`),j(`Click on the map to place a new province center`,!0),v(`#viewbox`).style(`cursor`,`crosshair`).on(`click`,Ke),g(`provincesBodySection`).querySelectorAll(`div > input, select, span, svg`).forEach(e=>{e.style.pointerEvents=`none`})}function Ke(e){let{cells:t,provinces:n}=pack,r=o(e,this),i=Pack.findCell(r[0],r[1]);if(t.h[i]<20){j(`You cannot place province into the water. Please click on a land cell`,!1,`error`);return}let a=t.province[i];if(a&&n[a].center===i){j(`The cell is already a center of a different province. Select other cell`,!1,`error`);return}let s=t.state[i];if(!s){j(`You cannot create a province in neutral lands. Please assign this land to a state first`,!1,`error`);return}e.shiftKey===!1&&Q();let c=n.length;pack.states[s].provinces.push(c);let u=t.burg[i],f=t.culture[i],m=u?pack.burgs[u].name:Names.getState(Names.getCultureShort(f),f),_=a?n[a].formName:`Province`,v=`${m} ${_}`,y=pack.states[s].color,b=h(),S=y[0]===`#`?d(l(y,b)(.2)).hex():b,C=u?.8:.4,w=u?pack.burgs[u].coa:pack.states[s].coa,T=u?pack.burgs[u].port:void 0,D=Burgs.getType(i,T),O=I.generate(w,C,+p(.1),D);O.shield=I.getShield(f,s),n.push({i:c,state:s,center:i,burg:u,name:m,formName:_,fullName:v,color:S,coa:O}),x(`province`,c),t.province[i]=c,t.c[i].forEach(e=>{t.h[e]<20||t.state[e]!==s||n.find(t=>!t.removed&&t.center===e)||(t.province[e]=c)}),E.draw(`borders`,`provinces`),E.draw(`labels`),J(),V.stateId=s,L.set(z,`filters`,V),g(`provincesFilterState`).value=String(V.stateId),G.reset()}function Q(){customization=0,ae(),re(),g(`provincesBodySection`).querySelectorAll(`div > input, select, span, svg`).forEach(e=>{e.style.removeProperty(`pointer-events`)});let e=g(`provincesAdd`);e.classList.contains(`pressed`)&&e.classList.remove(`pressed`)}function qe(){let e=V.stateId;pack.provinces.forEach(t=>{if(!t||t.removed||e!==-1&&t.state!==e)return;let n=pack.states[t.state].color,r=h();t.color=n[0]===`#`?d(l(n,r)(.2)).hex():r}),E.show(`provinces`)}function Je(){let e=`Id,Province,Full Name,Form,State,Color,Capital,Area ${areaUnit.value===`square`?`${distanceUnitInput.value}2`:areaUnit.value},Total Population,Rural Population,Urban Population,Burgs\n`;for(let t of Y()){let n=t.burg?pack.burgs[t.burg].name:``;e+=`${t.i},${t.name},${t.fullName},${t.formName},${pack.states[t.state].name},${t.color},${n},${H(t)},${U(t)},${Math.round(t.rural*populationRate)},${Math.round(t.urban*populationRate*urbanization)},${t.burgs.length}\n`}let t=`${n(`Provinces`)}.csv`;s(e,t)}function Ye(){alertMessage.innerHTML=`Are you sure you want to remove all provinces? <br />This action cannot be reverted`,$(`#alert`).dialog({resizable:!1,title:`Remove all provinces`,buttons:{Remove:function(){$(this).dialog(`close`),pack.provinces.forEach(e=>{e.i&&S(`province`,e.i)}),pack.provinces=[0],pack.cells.province=new Uint16Array(pack.cells.i.length),pack.states.forEach(e=>{e.provinces=[]}),T(),E.draw(`borders`),v(`#provs`).select(`#provincesBody`).remove(),E.hide(`provinces`),E.draw(`labels`),G.reset()},Cancel:function(){$(this).dialog(`close`)}}})}function Xe(){customization===12&&Q(),$(`#provincesEditor`).dialog(`destroy`),g(`provincesEditor`).remove()}function Ze(){let e=V.stateId;if(e===-1){alertMessage.innerHTML=`Please select a specific state from the filter to merge provinces within that state.`,$(`#alert`).dialog({title:`Merge Provinces`,buttons:{OK:function(){$(this).dialog(`close`)}}});return}let t=pack.provinces.filter(t=>t.i&&!t.removed&&t.state===e);if(t.length<2){alertMessage.innerHTML=`Not enough provinces in the selected state to merge.`,$(`#alert`).dialog({title:`Merge Provinces`,buttons:{OK:function(){$(this).dialog(`close`)}}});return}let n=e=>`<svg class="coaIcon" viewBox="0 0 200 200"><use href="#provinceCOA${e}"></use></svg>`,r=t.map(e=>`
  ...
  `,g(`mergeProvincesForm`).querySelectorAll(`div[data-id]`).forEach(e=>{e.addEventListener(`mouseenter`,Qe),e.addEventListener(`mouseleave`,Z)}),$(`#alert`).dialog({width:600,title:`Merge provinces`,close:Z,buttons:{Merge:function(){let e=new FormData(g(`mergeProvincesForm`)),t=Number(e.get(`rulingProvince`));if(!t){j(`Please select a province to merge into`,!1,`error`);return}let r=e.getAll(`provincesToMerge`).map(Number).filter(e=>e!==t);if(!r.length){j(`Please select several provinces to merge`,!1,`error`);return}N({title:`Merge provinces`,message:`
            ...
            <p>Are you sure you want to merge provinces? This action cannot be reverted.</p>`,confirm:`Merge`,onConfirm:()=>{et(r,t),$(this).dialog(`close`)}})},Cancel:function(){$(this).dialog(`close`)}}})}function Qe(e){if(!E.isOn(`provinces`))return;let t=+e.currentTarget.dataset.id;if(!t)return;let n=v(`#provs`).select(`#province${t}`).attr(`d`);if(!n)return;Z(e);let r=v(`#debug`).append(`path`).attr(`class`,`highlight`).attr(`d`,n).attr(`fill`,`none`).attr(`stroke`,`red`).attr(`stroke-width`,1).attr(`opacity`,1).attr(`filter`,`url(#blur1)`),i=r.node().getTotalLength(),o=(i+5e3)/2,s=a(`0, ${i}`,`${i}, ${i}`);r.transition().duration(o).attrTween(`stroke-dasharray`,()=>s)}function $e(e){T(`focusProvince${e}`),S(`province`,e)}function et(e,t){let n=pack.provinces[t],r=new Map;e.forEach(e=>{if(e===t)return;let i=pack.provinces[e];i.burgs.forEach(e=>{pack.burgs[e].province=t,n.burgs.includes(e)||n.burgs.push(e)}),!n.burg&&i.burg&&(n.burg=i.burg),r.set(e,t),$e(e),pack.provinces[e]={i:e,removed:!0}}),pack.cells.province.forEach((e,t)=>{let n=r.get(e);n!==void 0&&(pack.cells.province[t]=n)});let i=pack.states[n.state];i.provinces=i.provinces.filter(e=>!pack.provinces[e].removed),J(),Provinces.getPoles(),E.draw(`provinces`,`borders`),E.draw(`labels`),T(),v(`#debug`).selectAll(`.highlight`).remove(),q()}function tt(e,t){let n=pack.provinces[e];n.lock=!n.lock,t.toggle(`icon-lock-open`),t.toggle(`icon-lock`)}var nt={open:K};export{nt as ProvincesEditor};