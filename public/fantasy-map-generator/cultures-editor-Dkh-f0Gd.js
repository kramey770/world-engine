import{Bt as e,C as t,M as n,N as r,P as i,S as a,Tt as o,at as s,d as c,i as l,k as u,r as d,un as f,vt as p,z as m}from"./utils-omhVlsRt.js";import{C as ee,j as te,t as h,x as ne}from"./layers-DHltDypB.js";import{t as re}from"./drag-BkOXJRRX.js";import{t as ie}from"./sin-DXK16t1M.js";import{t as ae}from"./highlight-D0bzltDC.js";import{t as oe}from"./heightUtils-BfaaFPbS.js";import{r as g,t as _}from"./tooltips-BQ3W48fB.js";import{a as v,n as se,r as ce,t as le}from"./dialog-helpers-CdcIkxap.js";import{t as y}from"./emblems-generator-BN5o8bHo.js";import{t as b}from"./cultures-generator-BrxAhK52.js";import{P as x,b as ue,j as de,y as fe}from"./index-DWZM8gkY.js";import{t as pe}from"./highlighting-D_bHr-1Y.js";import{a as me,i as he,n as ge,r as _e,t as ve}from"./table-DM0fGDYA.js";var S={},C={},w=34,T=10,E=13;function D(e){return Function(`d`,`return {`+e.map(function(e,t){return JSON.stringify(e)+`: d[`+t+`] || ""`}).join(`,`)+`}`)}function ye(e,t){var n=D(e);return function(r,i){return t(n(r),i,e)}}function O(e){var t=Object.create(null),n=[];return e.forEach(function(e){for(var r in e)r in t||n.push(t[r]=r)}),n}function k(e,t){var n=e+``,r=n.length;return r<t?Array(t-r+1).join(0)+n:n}function be(e){return e<0?`-`+k(-e,6):e>9999?`+`+k(e,6):k(e,4)}function A(e){var t=e.getUTCHours(),n=e.getUTCMinutes(),r=e.getUTCSeconds(),i=e.getUTCMilliseconds();return isNaN(e)?`Invalid Date`:be(e.getUTCFullYear(),4)+`-`+k(e.getUTCMonth()+1,2)+`-`+k(e.getUTCDate(),2)+(i?`T`+k(t,2)+`:`+k(n,2)+`:`+k(r,2)+`.`+k(i,3)+`Z`:r?`T`+k(t,2)+`:`+k(n,2)+`:`+k(r,2)+`Z`:n||t?`T`+k(t,2)+`:`+k(n,2)+`Z`:``)}function j(e){var t=RegExp(`["`+e+`
    ...
    <div id="culturesBottom" class="editorToolbar">
      ...
      >
        ...
        >
          ...
          <div data-col="emblems">${U(y.isDiversiform,r.shield)}</div>
