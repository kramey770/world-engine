import{Et as e,N as t,at as n,k as r,w as i,wn as a}from"./utils-BXw8fBj4.js";import{t as o}from"./layers-_nptVsMl.js";import{r as s}from"./tooltips-0xeyl30m.js";import{i as c,r as l}from"./dialog-helpers-DT2MP2B1.js";import{t as u}from"./cultures-generator-CcVwJtnL.js";import{n as d,t as f}from"./goods-generator-Bqn9abxY.js";import{P as p}from"./index-CHSGsxIV.js";function m(n,i){let u=Array.from(r(`good-icons`).querySelectorAll(`symbol`)).map(e=>e.id),m={...n?.demandCoverage||{}},b={...n?.biomeOutput||{}},x=()=>{let e=d.map(e=>[e,m[e]??0]).filter(([,e])=>e>0);return e.length?e.map(([e,n])=>`${f[e]} ${t(e)}: ${n}`).join(`, `):`none`},S=()=>{let e=Object.entries(b).filter(([,e])=>(e??0)>0);return e.length?e.map(([e,t])=>`${pack.biomes[Number(e)].name}: ${t}`).join(`, `):`none`},C={cultureType:{...n?.multipliers?.cultureType??{}},culture:{...n?.multipliers?.culture??{}},state:{...n?.multipliers?.state??{}},religion:{...n?.multipliers?.religion??{}},biome:{...n?.multipliers?.biome??{}},zone:{...n?.multipliers?.zone??{}}},w=t=>{let n=C[t]??{},r=Object.entries(n).filter(([,e])=>e!==1);return r.length?r.map(([n,r])=>`${h(t,n)} ×${e(r,2)}`).join(`, `):`none`},T=(e,t)=>`
