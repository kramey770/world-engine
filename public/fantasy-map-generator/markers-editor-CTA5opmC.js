import{A as e,Tt as t,k as n,un as r}from"./utils-omhVlsRt.js";import{y as i}from"./layers-DHltDypB.js";import{t as a}from"./drag-BkOXJRRX.js";import{t as o}from"./tooltips-BQ3W48fB.js";import{i as s,n as c,r as l,t as u}from"./dialog-helpers-CdcIkxap.js";import{M as d,P as f}from"./index-DWZM8gkY.js";var p,m;function h(t,n){if(customization)return;u(`.stable`);let i=_(t,n);i&&([p,m]=i,r(p).raise().call(a().on(`start`,y)).classed(`draggable`,!0),e(`notesEditor`)&&f.NotesEditor.open(p.id,p.id),g(),b(),$(`#markerEditor`).dialog({title:`Edit Marker`,resizable:!1,position:{my:`left top`,at:`left+10 top+10`,of:`svg`,collision:`fit`},close:R}))}function g(){l(`markerEditor`),n(`dialogs`).insertAdjacentHTML(`beforeend`,`<div id="markerEditor" class="dialog">
