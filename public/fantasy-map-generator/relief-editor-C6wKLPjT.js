import{Et as e,M as t,N as n,dn as r,hn as i,k as a}from"./utils-BXw8fBj4.js";import{m as o,p as s,t as c}from"./layers-_nptVsMl.js";import{t as l}from"./drag-BxIG-06a.js";import{u}from"./megalopolis-BpsA5rhH.js";import{n as d,r as f,t as p}from"./tooltips-0xeyl30m.js";import{r as m,t as h}from"./dialog-helpers-DT2MP2B1.js";import{n as g,t as _}from"./brush-circle-5_MK8VXE.js";import{F as v,a as y,j as b,o as x,s as S}from"./index-CHSGsxIV.js";var C=40,w=null,T=()=>Object.entries(S).map(([e,{name:t}])=>`<option value="${e}">${t}</option>`).join(``),E=()=>Object.keys(S).map(e=>`<div data-type="${e}" style="display: none">${D(e)}</div>`).join(``),D=e=>x.filter(({set:t})=>t===S[e].base).flatMap(({type:t,variants:r,zoom:i=1})=>{let a=C*i,o=50-50*i,s=n(t.replace(/([A-Z])/g,` $1`).toLowerCase());return r.map(n=>{let r=y(t,n,e);return`<svg data-type="${r}" data-tip="Select ${s} icon">
