import{C as e,Et as t,J as n,S as r,dn as i,k as a}from"./utils-BIleyWmR.js";import{A as o,E as s,j as c}from"./layers-qPZxwHcp.js";import{t as l}from"./drag-Ck8KuEBm.js";import{n as u}from"./highlight-NHRsf3Ou.js";import{r as d,t as f}from"./tooltips-zkair8Am.js";import{r as p}from"./dialog-helpers-50LJgx0U.js";import{t as m}from"./emblems-generator-Dcd7BXhM.js";var h,g,_,v;async function y(){let e=pack.states.find(e=>e.i&&!e.removed&&e.coa),t=pack.burgs.find(e=>e.i&&!e.removed&&e.coa),n=e?`state`:`burg`,r=e??t;if(!r?.coa){d(`No emblems to edit, please generate states and burgs first`,!1,`error`);return}let i=`${n}COA${r.i}`;await c.trigger(i,r.coa),b(n,i,r)}function b(e,t,n,r){if(!customization){if(!t&&r)S(r);else{if(!e||!t||!n?.coa)return;h=e,g=t,_=n}x(),q(),v?.(),v=o(q),C(),$(`#emblemEditor`).dialog({title:`Edit Emblem`,resizable:!0,width:`18.2em`,height:`auto`,position:{my:`left top`,at:`left+10 top+10`,of:`svg`,collision:`fit`},close:J})}}function x(){p(`emblemEditor`),a(`dialogs`).insertAdjacentHTML(`beforeend`,`<div id="emblemEditor" class="dialog stable">
