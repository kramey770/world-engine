import{A as e,Cn as t,Tt as n,X as r,c as i,d as a,hn as o,i as s,k as c,r as l,un as u,yt as d}from"./utils-omhVlsRt.js";import{t as f}from"./layers-DHltDypB.js";import{t as p}from"./mean-4Awewi9R.js";import{t as m}from"./drag-BkOXJRRX.js";import{r as h}from"./tooltips-BQ3W48fB.js";import{t as g}from"./coastline-generator-DoQgut8s.js";import{r as _,t as v}from"./dialog-helpers-CdcIkxap.js";import{P as y,j as b}from"./index-DWZM8gkY.js";import{t as x}from"./graph-override-CBeAyInQ.js";function S(e){for(var t=-1,n=e.length,r=e[n-1],i,a,o=r[0],s=r[1],c=0;++t<n;)i=o,a=s,r=e[t],o=r[0],s=r[1],i-=o,a-=s,c+=Math.hypot(i,a);return c}var C;function w(e){customization||(v(`.stable`),f.hide(`cells`),T(),u(`#debug`).append(`g`).attr(`id`,`vertices`),C=u(e),D(),I(),O(),u(`#viewbox`).on(`touchmove mousemove`,null),$(`#lakeEditor`).dialog({title:`Edit Lake`,resizable:!1,position:{my:`center top+20`,at:`top`,of:`svg`,collision:`fit`},close:U}))}function T(){_(`lakeEditor`),c(`dialogs`).insertAdjacentHTML(`beforeend`,`<div id="lakeEditor" class="dialog">
