import{F as e,M as t,X as n,jt as r,k as i,un as a}from"./utils-omhVlsRt.js";import{c as o,i as s,o as c,t as l}from"./layers-DHltDypB.js";import{t as u}from"./drag-BkOXJRRX.js";import{t as ee}from"./natural-YfJp6loN.js";import{n as d,r as f}from"./tooltips-BQ3W48fB.js";import{n as p,r as m,t as te}from"./dialog-helpers-CdcIkxap.js";import{P as h,j as ne}from"./index-DWZM8gkY.js";import{t as g}from"./label-arc-BKEVtNcp.js";var _=``,v;function y(e,t){if(customization)return;te(`.stable`),l.show(`labels`);let n=document.querySelector(`#labels text[data-label-type='${e}'][data-id='${t}']`);if(!n)return;let r=s(e,t);r&&(v={...r},Q(n.id),a(`#viewbox`).on(`touchmove mousemove`,D),b(),$(`#labelEditor`).dialog({title:`Edit Label`,resizable:!1,width:fitContent(),position:{my:`center top+10`,at:`bottom`,of:n,collision:`fit`},close:de}),O(),x(v.group),w(),S())}function b(){m(`labelEditor`),i(`dialogs`).insertAdjacentHTML(`beforeend`,`<div id="labelEditor" class="dialog">
