import{C as e,Et as t,M as n,S as r,dn as i,k as a,n as o}from"./utils-BXw8fBj4.js";import{j as s,t as c}from"./layers-_nptVsMl.js";import{r as l,t as u}from"./tooltips-0xeyl30m.js";import{a as d,t as f}from"./dialog-helpers-DT2MP2B1.js";import{P as p,b as m,j as h,y as g}from"./index-CHSGsxIV.js";import{i as _,n as v,r as y,t as b}from"./table-CN7n7WQR.js";var x=0,S=`marketOverview`,C={my:`right top`,at:`right-10 top+10`,of:`svg`,collision:`fit`},w=[{key:`icon`,width:`2.5em`,permanent:!0},{key:`good`,label:`Good`,width:`8em`,permanent:!0,sortBy:e=>e.good,sortType:`alpha`},{key:`stock`,label:`Stock`,width:`5em`,sortBy:e=>e.stock,defaultSort:`desc`},{key:`price`,label:`Price`,width:`5em`,sortBy:e=>e.price},{key:`actions`,width:`1.2em`,permanent:!0}],T=v({getData:j,onUpdate:M});function E(e){if(customization)return;let t=Markets.get(e);if(!t){l(`Invalid market. The selected market does not exist`,!0,`error`,5e3);return}x=e,f(`#${S}, .stable`),D(),T.reset(),O(t),$(`#${S}`).dialog({title:`Market Stock: ${Markets.getName(t)}`,width:`auto`,close:I,position:C})}function D(){document.getElementById(S)?.remove();let e=`<div id="${S}" class="dialog stable editorDialog">
