import{Et as e,k as t}from"./utils-BIleyWmR.js";import{t as n}from"./layers-qPZxwHcp.js";import{r}from"./dialog-helpers-50LJgx0U.js";import{n as i}from"./index-tuMZPduM.js";var a=!1,o=0,s=0;function c(){l(),u(),f(),$(`#transformTool`).dialog({title:`Transform map`,resizable:!1,position:{my:`center`,at:`center`,of:`svg`},close:d,buttons:{Transform:function(){y(),$(this).dialog(`close`)},Cancel:function(){$(this).dialog(`close`)}}})}function l(){r(`transformTool`);let e=t(`pointsInput`).value,n=cellsDensityMap[+e],i=`<div id="transformTool" class="dialog">
