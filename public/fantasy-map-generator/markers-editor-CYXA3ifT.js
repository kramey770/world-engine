import{A as e,Et as t,dn as n,k as r}from"./utils-BIleyWmR.js";import{y as i}from"./layers-qPZxwHcp.js";import{t as a}from"./drag-Ck8KuEBm.js";import{t as o}from"./tooltips-zkair8Am.js";import{i as s,n as c,r as l,t as u}from"./dialog-helpers-50LJgx0U.js";import{M as d,P as f}from"./index-tuMZPduM.js";var p,m;function h(t,r){if(customization)return;u(`.stable`);let i=_(t,r);i&&([p,m]=i,n(p).raise().call(a().on(`start`,y)).classed(`draggable`,!0),e(`notesEditor`)&&f.NotesEditor.open(p.id,p.id),g(),b(),$(`#markerEditor`).dialog({title:`Edit Marker`,resizable:!1,position:{my:`left top`,at:`left+10 top+10`,of:`svg`,collision:`fit`},close:R}))}function g(){l(`markerEditor`),r(`dialogs`).insertAdjacentHTML(`beforeend`,`<div id="markerEditor" class="dialog">
