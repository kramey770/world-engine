...
const aleaPRNG = function () {
	return ((n) => {
		...
		return (
			(l.fract53 = () => l() + 1.1102230246251565e-16 * ((2097152 * l()) | 0)),
			(l.int32 = () => 4294967296 * l()),
			(l.cycle = (n) => {
			...
			(l.range = function () {
				...
				return (
					...
					arguments[0] > arguments[1] &&
						((n = arguments[1]), (r = arguments[0])),
					f(n) && f(r) ? Math.floor(l() * (r - n + 1)) + n : l() * (r - n) + n
				);
			}),
			(l.restart = () => {
				c(a);
			...
			(l.version = () => "aleaPRNG 1.1.0"),
			(l.versions = () => "aleaPRNG 1.1.0, " + i),
			0 === n.length &&
				(window.crypto.getRandomValues(u), (n = [u[0], u[1], u[2]])),
			(a = n),
			c(n),
			l
		);
