...
!(() => {
	...
	class oa {
		...
		bind(e, t, n, o) {
			...
			const a = window,
				i = (e) => {
					this.executeHandlers(ta(e || a.event), l);
				};
						...
						: (this.hasFocusIn ||
							...
							s
								...
								: ((this.events[l][t] = s = [{ func: n, scope: o }]),
									...
									(s.capture = m),
									(s.nativeHandler = u),
									"ready" === t ? na(e, u, this) : Js(e, f || t, u, m)));
			}
			return (e = s = null), n;
		}
		unbind(e, t, n) {
	...
	class pa {
		...
		loadScripts(e) {
			const n = (e, n) => {
					Ee(this.scriptLoadedCallbacks, n).each((t) => {
						q(t, (t) => t[e](n));
					}),
	...
	class ep {
				...
				if (void 0 !== t) {
					if (null === t) {
						if (e in o.map) {
							delete o.map[e];
							let t = o.length;
							for (; t--; ) if (o[t].name === e) return o.splice(t, 1), this;
						}
						return this;
					}
					if (e in o.map) {
		...
		clone() {
			const t = new ep(this.name, this.type),
				n = this.attributes;
			if (n) {
				const e = [];
				e.map = {};
		...
		getAll(e) {
			const n = [];
			for (let o = this.firstChild; o; o = Zg(o, this))
				o.name === e && n.push(o);
			return n;
		}
		children() {
		...
		empty() {
			if (this.firstChild) {
				const t = [];
				for (let n = this.firstChild; n; n = Zg(n, this)) t.push(n);
				let n = t.length;
				for (; n--; ) {
					const e = t[n];
	...
	var oC = (function e() {
		...
		const xe = s.createElement("form"),
			Ee = (e) => e instanceof RegExp || e instanceof Function,
			ke = (e) => {
				if (!we || we !== e) {
					if (
						((e && "object" == typeof e) || (e = {}),
	...
	const MA = (e, t) => Math.abs(e.left - t),
		...
		sO = (e, t, n) =>
			I.from(t)
				...
				.map((t) => ({
					url: `${e.editorManager.baseURL}/icons/${t}/icons${n}.min.js`,
					name: I.some(t),
				})),
		aO = (e, t) => {
			...
			((e, t) => {
				...
				((e, t) => {
					...
					if (!ya.hasCode(n) && "en" !== n) {
						const r = Ge(o)
							? o
							: `${t.editorManager.baseURL}/langs/${n}.min.js`;
						e.add(r).catch(() => {
							((e, t, n) => {
		...
		HO = {
			...
			dispatch(e, t, n) {
				if (this.removed && "remove" !== e && "detach" !== e)
					return Zs(e.toLowerCase(), null != t ? t : {}, this);
				const r = jO(this).dispatch(e, t);
				if (!1 !== n && this.parent) {
					let t = this.parent();
	...
	const qO = (e, t) => {
		...
		YO = {
			...
			bindPendingEventDelegates() {
				Dt.each(this._pendingNativeEvents, (t) => {
					KO(this, t);
				});
			},
				...
				"focus" !== e &&
					...
					(this.removed ||
						(t
							...
							: this.initialized &&
								this.delegates &&
								(this.dom.unbind(qO(this, e), e, this.delegates[e]),
	...
	class uB {
		constructor(e, t, n) {
			...
			C(d) && fa.DOM.styleSheetLoader._setContentCssCors(d),
				...
				this.setDirty(!1),
				(this.documentBaseURI = new cC(jl(this), { base_uri: this.baseUri })),
				(this.baseURI = this.baseUri),
				(this.inline = Dd(this)),
				(this.hasVisual = Kd(this)),
		...
		show() {
			this.hidden &&
				...
				this.inline
					...
					: (lB.show(this.getContainer()), lB.hide(this.id)),
				this.load(),
				this.dispatch("show"));
		}
		hide() {
			this.hidden ||
				...
				this.inline
					...
					: (lB.hide(this.getContainer()),
						lB.setStyle(this.id, "display", this.orgDisplay)),
				(this.hidden = !0),
				this.dispatch("hide"));
		}
		isHidden() {
		...
		load(e = {}) {
			...
			if (n) {
				const o = { ...e, load: !0 },
					...
					s = this.setContent(r, o);
				return (
					o.no_events || this.dispatch("LoadContent", { ...o, element: n }), s
				);
			}
			return "";
		}
		save(e = {}) {
			...
			if (
				...
				const o = lB.getParent(this.id, "form");
				o && cB(o.elements, (e) => e.name !== this.id || ((e.value = r), !1));
			}
			return (
		...
		getContainer() {
			return (
				this.container ||
					(this.container =
						this.editorContainer || lB.get(this.id + "_parent")),
				this.container
			);
		}
	...
	const bB = (e) => {
		...
		wB = {
			...
			setup() {
				...
				var s;
				(this.baseURL = new cC(o).toAbsolute(t)),
					(this.documentBaseURL = o),
					(this.baseURI = new cC(this.baseURL)),
					(this.suffix = n),
					(s = this).on("AddEditor", T(Ig, s)),
			...
			remove(e) {
				...
				if (e) {
					if (!m(e))
						return (
							...
							h(this.get(n.id))
								? null
								: (yB(n) && this.dispatch("RemoveEditor", { editor: n }),
									0 === hB.length &&
				...
				} else for (let e = hB.length - 1; e >= 0; e--) this.remove(hB[e]);
			},
			execCommand(e, t, n) {
				var o;
				const s = f(n)
