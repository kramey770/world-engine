...
!((t, n) => {
	...
	function x(t, n, e) {
		var r = (n - t) / Math.max(0, e),
			...
			o = r / 10 ** i;
		return i >= 0
			? (o >= y ? 10 : o >= _ ? 5 : o >= b ? 2 : 1) * 10 ** i
			: -(10 ** -i) / (o >= y ? 10 : o >= _ ? 5 : o >= b ? 2 : 1);
	}
	function w(t, n, e) {
		var r = Math.abs(n - t) / Math.max(0, e),
			i = 10 ** Math.floor(Math.log(r) / Math.LN10),
			o = r / i;
		return (
	...
	function B(t, n) {
		...
		function l(l) {
				...
				_ = (
					n.bandwidth
						? (t) => {
								...
								return t.round() && (n = Math.round(n)), (e) => +t(e) + n;
							}
						: (t) => (n) => +t(n)
				)(n.copy()),
			...
			(m = m.merge(
				...
				x.attr("opacity", 1).attr("transform", (t) => s(_(t))),
				N.attr(f + "2", c * o),
				A.attr(f, c * p).text(d),
				b
					.filter(Y)
	...
	function $(t) {
		...
		return (
			...
			Object.hasOwn(V, n) ? { space: V[n], local: t } : t
		);
	}
	function W(t) {
		var n = $(t);
	...
	function kt(t, n, e) {
		var r = Object.hasOwn(wt, t.type) ? Mt : Nt;
	...
	function le(t, n) {
		var e = new Date();
		return (n -= t = +t), (r) => (e.setTime(t + n * r), e);
	}
	function he(t, n) {
		return (n -= t = +t), (e) => t + n * e;
	}
	function de(t, n) {
		var e,
			r = {},
	...
	function _e(t, n) {
		return (n -= t = +t), (e) => Math.round(t + n * e);
	}
	var be,
		me,
		xe,
	...
	function qe(t, n) {
		...
		if (h < ze)
			(r = Math.log(f / a) / Ee),
				(e = (t) => [i + t * s, o + t * l, a * Math.exp(Ee * t * r)]);
		else {
			var d = Math.sqrt(h),
	...
	function Fr(t) {
		return ((t *= 2) <= 1 ? 2 ** (10 * t - 10) : 2 - 2 ** (10 - 10 * t)) / 2;
	}
	function Ir(t) {
		return (
			((t *= 2) <= 1
	...
	var ti = (function t(n) {
		...
		ii = (function t(n, e) {
			...
			function i(t) {
				return n * 2 ** (10 * --t) * Math.sin((r - t) / e);
			}
			return (
				(i.amplitude = (n) => t(n, e * ri)), (i.period = (e) => t(n, e)), i
			);
		})(1, 0.3),
		oi = (function t(n, e) {
			var r = Math.asin(1 / (n = Math.max(1, n))) * (e /= ri);
			function i(t) {
				return 1 - n * 2 ** (-10 * (t = +t)) * Math.sin((t + r) / e);
			}
			return (
				(i.amplitude = (n) => t(n, e * ri)), (i.period = (e) => t(n, e)), i
			);
		...
		ai = (function t(n, e) {
			...
			function i(t) {
				return (
					((t = 2 * t - 1) < 0
						? n * 2 ** (10 * t) * Math.sin((r - t) / e)
						: 2 - n * 2 ** (-10 * t) * Math.sin((r + t) / e)) / 2
				);
			}
			return (
				(i.amplitude = (n) => t(n, e * ri)), (i.period = (e) => t(n, e)), i
	...
	function Pi(n) {
		...
		function u(t) {
			...
			var r = t.selectAll(".handle").data(n.handles, (t) => t.type);
			r.exit().remove(),
				r
					.enter()
					.append("rect")
					.attr("class", (t) => "handle handle--" + t.type)
					.attr("cursor", (t) => xi[t.type]),
				t
					.each(c)
					.attr("fill", "none")
					.attr("pointer-events", "all")
	...
	function ko(t) {
		...
		return {
			...
			format: (n, e) => (
				...
				[e.map(o).join(t)]
					.concat(n.map((n) => e.map((t) => o(n[t])).join(t)))
					.join("\n")
			),
			formatRows: (t) => t.map(i).join("\n"),
		};
	}
	var So = ko(","),
		To = So.parse,
	...
	function Xo(t) {
		return (n, e) =>
			Bo(n, e).then((n) => new DOMParser().parseFromString(n, t));
	}
	...
	function eu() {}
	function ru(t, n) {
		t && Object.hasOwn(ou, t.type) && ou[t.type](t, n);
	}
	var iu = {
			Feature: (t, n) => {
				ru(t.geometry, n);
	...
	function cu(t, n) {
		t && Object.hasOwn(iu, t.type) ? iu[t.type](t, n) : ru(t, n);
	}
	var fu,
		su,
		lu,
	...
	function Nc(t, n) {
		...
		return (
			t.invert &&
				n.invert &&
				(e.invert = (e, r) => (e = n.invert(e, r)) && t.invert(e[0], e[1])),
			e
		);
	}
	function Ac(t, n) {
	...
	function Sc(t) {
		return (n, e) => [(n += t) > Da ? n - Oa : n < -Da ? n + Oa : n, e];
	}
	function Tc(t) {
		var n = Sc(t);
	...
	function Cc(t) {
		...
		return (
			...
			(n.invert = (n) => (
				((n = t.invert(n[0] * Ba, n[1] * Ba))[0] *= Ya), (n[1] *= Ya), n
			)),
			n
		);
	}
	...
	var uf = {
		...
		cf = {
			Sphere: () => !0,
			Point: (t, n) => sf(t.coordinates, n),
			MultiPoint: (t, n) => {
				for (var e = t.coordinates, r = -1, i = e.length; ++r < i; )
					if (sf(e[r], n)) return !0;
				return !1;
			},
			LineString: (t, n) => lf(t.coordinates, n),
			MultiLineString: (t, n) => {
				for (var e = t.coordinates, r = -1, i = e.length; ++r < i; )
					if (lf(e[r], n)) return !0;
				return !1;
			},
			Polygon: (t, n) => hf(t.coordinates, n),
			MultiPolygon: (t, n) => {
				for (var e = t.coordinates, r = -1, i = e.length; ++r < i; )
	...
	function ff(t, n) {
		return !(!t || !Object.hasOwn(cf, t.type)) && cf[t.type](t, n);
	}
	function sf(t, n) {
		return 0 === af(t, n);
	}
	...
	function yf() {
		...
		return (
			(_.lines = () =>
				b().map((t) => ({ type: "LineString", coordinates: t }))),
			(_.outline = () => ({
				type: "Polygon",
				coordinates: [
					s(r).concat(
	...
	function Ss(t, n, e, r) {
		...
		return (h.invert = (t, n) => [c * t - f * n + s, l - f * t - c * n]), h;
	}
	function Ts(t) {
		return Es(() => t)();
	}
	function Es(t) {
				...
				r = (
					b
						...
						: (t, n, e) => {
								...
								return (r.invert = (r, i) => [(r - n) / t, (e - i) / t]), r;
							}
				)(l, h - t[0], d - t[1], b);
			return (
		...
		return (
			...
			(A.fitExtent = (t, n) => bs(A, t, n)),
			(A.fitSize = (t, n) => ms(A, t, n)),
			(A.fitWidth = (t, n) => xs(A, t, n)),
			(A.fitHeight = (t, n) => ws(A, t, n)),
			function () {
	...
	function Ps(t, n) {
		...
		if (Fa(r) < Ra)
			return ((t) => {
				...
				return (e.invert = (t, e) => [t / n, tu(e * n)]), e;
			})(t);
		var i = 1 + e * (2 * r - e),
			o = Qa(i) / r;
		function a(t, n) {
	...
	var Ls = qs((t) => Qa(2 / (1 + t)));
	Ls.invert = Ds((t) => 2 * tu(t / 2));
	var Us = qs((t) => (t = Ka(t)) && t / Wa(t));
	function Os(t, n) {
	...
	(Ws.invert = (t, n) => {
		...
		(Ks.invert = Ds(tu)),
		(tl.invert = Ds((t) => 2 * Ia(t))),
		(nl.invert = (t, n) => [-n, 2 * Ia(Ga(t)) - La]),
		(sl.prototype = al.prototype =
			{
				...
				links: function () {
					...
					return (
						this.each((e) => {
							e !== this && n.push({ source: e.parent, target: e });
						}),
						n
					);
				},
	...
	var $l = (function t(n) {
		...
		return (e.ratio = (n) => t((n = +n) > 1 ? n : 1)), e;
	})(Gl);
	var Wl = (function t(n) {
		function e(t, e, r, i, o) {
	...
	function hh() {
		...
		return (
			...
			(e.rangeRound = (t) => ((o = [+t[0], +t[1]]), (a = !0), s())),
			(e.bandwidth = () => n),
			(e.step = () => t),
			(e.round = function (t) {
				return arguments.length ? ((a = !!t), s()) : a;
			...
			(e.copy = () =>
				hh(r(), o).round(a).paddingInner(u).paddingOuter(c).align(f)),
	...
	function yh(t) {
		var n,
			...
			r = t[t.length - 1];
		return (
			e > r && ((n = e), (e = r), (r = n)), (t) => Math.max(e, Math.min(r, t))
		);
	}
	function _h(t, n, e) {
		var r = t[0],
	...
	function xh() {
		...
		return (
			(l.invert = (e) => f(n((o || (o = r(u, a.map(t), he)))(e)))),
			(l.domain = function (t) {
				return arguments.length
			...
			(l.rangeRound = (t) => ((u = fh.call(t)), (c = _e), s())),
			(l.clamp = function (t) {
			...
			return (
				(e = ((t) =>
					t === Math.E
						...
						: (10 === t && Math.log10) ||
							(2 === t && Math.log2) ||
							((t = Math.log(t)), (n) => Math.log(n) / t))(a)),
				(r = ((t) => (10 === t ? Ch : t === Math.E ? Math.exp : (n) => t ** n))(
					a,
				)),
	...
	function Rh(t) {
		return (n) => Math.sign(n) * Math.log1p(Math.abs(n / t));
	}
	function qh(t) {
		return (n) => Math.sign(n) * Math.expm1(Math.abs(n)) * t;
	}
	function Dh(t) {
		var n = 1,
			e = t(Rh(n), qh(n));
	...
	function Bh() {
		var t = Yh(xh());
		return (
			(t.copy = () => mh(t, Bh()).exponent(t.exponent())),
	...
	function bv(t, n, r, i, o, a, u, c, f) {
		...
		return (
			...
			(s.tickFormat = (t, n) => (null == n ? M : f(n))),
			(s.nice = (t, n) => {
				var e = h();
				return (t = N(t, e[0], e[e.length - 1], n)) ? h(Ah(e, t)) : s;
			}),
			(s.copy = () => mh(s, bv(t, n, r, i, o, a, u, c, f))),
			s
		);
	}
	function mv() {
	...
	function wv() {
		var t = Yh(mv());
		return (
			(t.copy = () => xv(t, wv()).exponent(t.exponent())),
	...
	function Nv() {
		var t = Yh(Mv());
		return (
			(t.copy = () => xv(t, Nv()).exponent(t.exponent())),
			ah.apply(t, arguments)
		);
	}
	function Av(t) {
	...
	function Hg(t) {
		var n = t.length;
		return (e) => t[Math.max(0, Math.min(n - 1, Math.floor(e * n)))];
	}
	var jg = Hg(
			Av(
	...
	function ky() {
		...
		return (
			...
			(t.outerRadius = t.y1),
			delete t.y1,
			(t.lineStartAngle = () => Ny(e())),
			delete t.lineX0,
			(t.lineEndAngle = () => Ny(r())),
			delete t.lineX1,
			(t.lineInnerRadius = () => Ny(i())),
			delete t.lineY0,
			(t.lineOuterRadius = () => Ny(o())),
			delete t.lineY1,
			(t.curve = function (t) {
				return arguments.length ? n(My(t)) : n()._curve;
			}),
		...
		point: function (t, n) {
			if (((t = +t), (n = +n), this._point)) {
				...
				this._l23_a = Math.sqrt(
					(this._l23_2a = (e * e + r * r) ** this._alpha),
				);
			}
			switch (this._point) {
				case 0:
			...
			((() => {
				for (var t, n, e, r, i = 0, o = db.length; i < o; ++i)
					if ((t = db[i]) && (r = (n = t.halfedges).length)) {
						...
						for (a.sort((t, n) => u[n] - u[t]), e = 0; e < r; ++e)
							u[e] = n[a[e]];
	...
	(bb.prototype = {
		...
		polygons: function () {
			var t = this.edges;
			return this.cells.map((n) => {
				var e = n.halfedges.map((e) => Q_(n, t[e]));
		...
		links: function () {
			return this.edges
				.filter((t) => t.right)
				.map((t) => ({ source: t.left.data, target: t.right.data }));
		},
		find: function (t, n, e) {
			for (
				var r, i, a = this._found || 0, u = this.cells.length;
				!(i = this.cells[a]);
			)
				if (++a >= u) return null;
			var c = t - i.site[0],
			...
			return (this._found = r), null == e || s <= e * e ? i.site : null;
		},
	}),
		(wb.prototype = {
			constructor: wb,
	...
	(Nb.prototype = wb.prototype),
		...
		(t.descending = (t, n) => (n < t ? -1 : n > t ? 1 : n >= t ? 0 : NaN)),
		(t.deviation = f),
		(t.extent = s),
		(t.histogram = () => {
			var t = v,
		...
		(t.thresholdFreedmanDiaconis = (t, e, r) => (
			(t = d.call(t, u).sort(n)),
			Math.ceil(
				(r - e) / (2 * (N(t, 0.75) - N(t, 0.25)) * t.length ** (-1 / 3)),
			)
		)),
		(t.thresholdScott = (t, n, e) =>
			Math.ceil((e - n) / (3.5 * f(t) * t.length ** (-1 / 3)))),
		...
		(t.chord = () => {
			...
			function i(i) {
				...
				for (
					n && d.sort((t, e) => n(h[t], h[e])),
						e &&
							p.forEach((t, n) => {
								t.sort((t, r) => e(i[n][t], i[n][r]));
							}),
				...
				entries: (t) =>
					(function t(e, o) {
						...
						return (
							...
							null != u ? a.sort((t, n) => u(t.key, n.key)) : a
						);
					})(o(t, 0, to, no), 0),
				key: (t) => (r.push(t), e),
				sortKeys: (t) => ((i[r.length - 1] = t), e),
				sortValues: (n) => ((t = n), e),
				rollup: (t) => ((n = t), e),
			});
		}),
		...
		(t.gray = (t, n) => new qn(t, 0, 0, null == n ? 1 : n)),
		(t.cubehelix = Zn),
		(t.contours = po),
		(t.contourDensity = () => {
			var t = yo,
			...
			function h(t) {
				return (t.value *= 2 ** (-2 * a)), t.coordinates.forEach(d), t;
			}
			function d(t) {
				t.forEach(p);
			}
		...
		(t.easeQuad = Rr),
		(t.easeQuadIn = (t) => t * t),
		(t.easeQuadOut = (t) => t * (2 - t)),
		(t.easeQuadInOut = Rr),
		(t.easeCubic = qr),
		(t.easeCubicIn = (t) => t * t * t),
		(t.easeCubicOut = (t) => --t * t * t + 1),
		(t.easeCubicInOut = qr),
		(t.easePoly = Ur),
		(t.easePolyIn = Dr),
		(t.easePolyOut = Lr),
		(t.easePolyInOut = Ur),
		(t.easeSin = Br),
		(t.easeSinIn = (t) => 1 - Math.cos(t * Yr)),
		(t.easeSinOut = (t) => Math.sin(t * Yr)),
		(t.easeSinInOut = Br),
		(t.easeExp = Fr),
		(t.easeExpIn = (t) => 2 ** (10 * t - 10)),
		(t.easeExpOut = (t) => 1 - 2 ** (-10 * t)),
		(t.easeExpInOut = Fr),
		(t.easeCircle = Ir),
		(t.easeCircleIn = (t) => 1 - Math.sqrt(1 - t * t)),
		(t.easeCircleOut = (t) => Math.sqrt(1 - --t * t)),
		(t.easeCircleInOut = Ir),
		(t.easeBounce = Kr),
		(t.easeBounceIn = (t) => 1 - Kr(1 - t)),
		(t.easeBounceOut = Kr),
		(t.easeBounceInOut = (t) =>
			((t *= 2) <= 1 ? 1 - Kr(1 - t) : Kr(t - 1) + 1) / 2),
		(t.easeBack = ei),
		(t.easeBackIn = ti),
		(t.easeBackOut = ni),
		(t.easeBackInOut = ei),
		...
		(t.blob = (t, n) => fetch(t, n).then(Uo)),
		(t.buffer = (t, n) => fetch(t, n).then(Oo)),
		(t.dsv = function (t, n, e, r) {
			3 === arguments.length &&
				"function" == typeof e &&
				((r = e), (e = void 0));
			var i = ko(t);
			return Bo(n, e).then((t) => i.parse(t, r));
		}),
		(t.csv = Io),
		(t.tsv = Ho),
		(t.image = (t, n) =>
		...
		(t.forceLink = (t) => {
			var n,
				...
				o,
				a = ua,
				u = (t) => 1 / Math.min(i[t.source.index], i[t.target.index]),
				c = Wo(30),
				f = 1;
			function s(r) {
		...
		(t.precisionRound = Ta),
		(t.geoArea = (t) => (vu.reset(), cu(t, gu), 2 * vu)),
		(t.geoBounds = (t) => {
			var n, e, r, i, o, a, u;
			if (
		...
		(t.geoClipExtent = () => {
			var t,
				...
				a = 500;
			return (e = {
				stream: (e) => (t && n === e ? t : (t = Vc(r, i, o, a)((n = e)))),
				extent: function (u) {
					return arguments.length
						? ((r = +u[0][0]),
							(i = +u[0][1]),
		...
		(t.geoContains = (t, n) =>
			(t && Object.hasOwn(uf, t.type) ? uf[t.type] : ff)(t, n)),
		(t.geoDistance = af),
		(t.geoGraticule = yf),
		(t.geoGraticule10 = () => yf()()),
		(t.geoInterpolate = (t, n) => {
			var e = t[0] * Ba,
				r = t[1] * Ba,
				i = n[0] * Ba,
				o = n[1] * Ba,
		...
		(t.geoPath = (t, n) => {
			...
			return (
				(o.area = (t) => (cu(t, e(Af)), Af.result())),
				(o.measure = (t) => (cu(t, e(ls)), ls.result())),
				(o.bounds = (t) => (cu(t, e(qf)), qf.result())),
				(o.centroid = (t) => (cu(t, e($f)), $f.result())),
		...
		(t.geoAlbersUsa = () => {
			...
			return (
				...
				(s.fitExtent = (t, n) => bs(s, t, n)),
				(s.fitSize = (t, n) => ms(s, t, n)),
				(s.fitWidth = (t, n) => xs(s, t, n)),
				(s.fitHeight = (t, n) => ws(s, t, n)),
				s.scale(1070)
			);
		}),
		(t.geoAzimuthalEqualArea = () => Ts(Ls).scale(124.75).clipAngle(179.999)),
		(t.geoAzimuthalEqualAreaRaw = Ls),
		(t.geoAzimuthalEquidistant = () =>
			Ts(Us).scale(79.4188).clipAngle(179.999)),
		(t.geoAzimuthalEquidistantRaw = Us),
		(t.geoConicConformal = () => Cs(Fs).scale(109.5).parallels([30, 30])),
		(t.geoConicConformalRaw = Fs),
		(t.geoConicEqualArea = zs),
		(t.geoConicEqualAreaRaw = Ps),
		(t.geoConicEquidistant = () => Cs(Hs).scale(131.154).center([0, 13.9389])),
		(t.geoConicEquidistantRaw = Hs),
		(t.geoEqualEarth = () => Ts(Ws).scale(177.158)),
		(t.geoEqualEarthRaw = Ws),
		(t.geoEquirectangular = () => Ts(Is).scale(152.63)),
		(t.geoEquirectangularRaw = Is),
		(t.geoGnomonic = () => Ts(Zs).scale(144.049).clipAngle(60)),
		(t.geoGnomonicRaw = Zs),
		(t.geoIdentity = () => {
			var t,
				n,
			...
			return (o = {
				...
				fitExtent: (t, n) => bs(o, t, n),
				fitSize: (t, n) => ms(o, t, n),
				fitWidth: (t, n) => xs(o, t, n),
				fitHeight: (t, n) => ws(o, t, n),
			});
		}),
		(t.geoProjection = Ts),
		(t.geoProjectionMutator = Es),
		(t.geoMercator = () => Ys(Os).scale(961 / Oa)),
		(t.geoMercatorRaw = Os),
		(t.geoNaturalEarth1 = () => Ts(Js).scale(175.295)),
		...
		(t.geoStereographic = () => Ts(tl).scale(250).clipAngle(142)),
		(t.geoStereographicRaw = tl),
		(t.geoTransverseMercator = () => {
			var t = Ys(nl),
				n = t.center,
				e = t.rotate;
			return (
		...
		(t.cluster = () => {
			...
			function i(i) {
				...
				i.eachAfter((n) => {
					var e = n.children;
					e
						? ((n.x = ((t) => t.reduce(rl, 0) / t.length)(e)),
							(n.y = ((t) => 1 + t.reduce(il, 0))(e)))
		...
		(t.interpolateDiscrete = (t) => {
			var n = t.length;
			return (e) => t[Math.max(0, Math.min(n - 1, Math.floor(e * n)))];
		}),
		(t.interpolateHue = (t, n) => {
			var e = re(+t, +n);
			return (t) => {
				var n = e(t);
		...
		(t.scaleLinear = function t() {
			var n = wh(vh, vh);
			return (n.copy = () => mh(n, t())), oh.apply(n, arguments), Nh(n);
		}),
		(t.scaleLog = function t() {
			var n = zh(xh()).domain([1, 10]);
			return (
				(n.copy = () => mh(n, t()).base(n.base())), oh.apply(n, arguments), n
			);
		}),
		(t.scaleSymlog = function t() {
			var n = Dh(xh());
			return (
				(n.copy = () => mh(n, t()).constant(n.constant())),
		...
		(t.scaleQuantile = function t() {
			...
			return (
				...
				(c.quantiles = () => a.slice()),
				(c.copy = () => t().domain(r).range(o).unknown(e)),
		...
		(t.scaleQuantize = function t() {
			...
			return (
				...
				(c.thresholds = () => a.slice()),
				(c.copy = () => t().domain([e, r]).range(u).unknown(n)),
		...
		(t.scaleThreshold = function t() {
			...
			return (
				...
				(a.copy = () => t().domain(e).range(r).unknown(n)),
		...
		(t.scaleSequential = function t() {
			var n = Nh(mv()(vh));
			return (n.copy = () => xv(n, t())), ah.apply(n, arguments);
		}),
		(t.scaleSequentialLog = function t() {
			var n = zh(mv()).domain([1, 10]);
			return (n.copy = () => xv(n, t()).base(n.base())), ah.apply(n, arguments);
		}),
		...
		(t.scaleSequentialSymlog = function t() {
			var n = Dh(mv());
			return (
				(n.copy = () => xv(n, t()).constant(n.constant())),
		...
		(t.create = (t) => zt(W(t).call(document.documentElement))),
		(t.creator = W),
		(t.local = qt),
		(t.matcher = tt),
		(t.mouse = Ot),
		...
		(t.pie = () => {
			...
			function a(a) {
				...
				for (
					null != n
						? p.sort((t, e) => n(v[t], v[e]))
						: null != e && p.sort((t, n) => e(a[t], a[n])),
						u = 0,
						f = d ? (y - h * b) / d : 0;
					u < h;
					++u, g = s
		...
		(t.radialLine = Ay),
		(t.pointRadial = Sy),
		(t.linkHorizontal = () => Py(zy)),
		(t.linkVertical = () => Py(Ry)),
		(t.linkRadial = () => {
			var t = Py(qy);
		...
		(t.symbolTriangle = Gy),
		(t.symbolWye = Zy),
		(t.curveBasisClosed = (t) => new n_(t)),
		(t.curveBasisOpen = (t) => new e_(t)),
		(t.curveBasis = (t) => new t_(t)),
		(t.curveBundle = i_),
		...
		(t.curveLinearClosed = (t) => new b_(t)),
		(t.curveLinear = py),
		(t.curveMonotoneX = (t) => new N_(t)),
		(t.curveMonotoneY = (t) => new A_(t)),
		(t.curveNatural = (t) => new S_(t)),
		(t.curveStep = (t) => new E_(t, 0.5)),
		(t.curveStepAfter = (t) => new E_(t, 1)),
		(t.curveStepBefore = (t) => new E_(t, 0)),
		(t.stack = () => {
			var t = $g([]),
				n = P_,
				e = C_,
		...
		(t.stackOrderDescending = (t) => D_(t).reverse()),
		(t.stackOrderInsideOut = (t) => {
			var n,
				e,
				r = t.length,
				i = t.map(L_),
		...
		(t.stackOrderNone = P_),
		(t.stackOrderReverse = (t) => P_(t).reverse()),
		(t.timeInterval = Hh),
		...
		(t.voronoi = () => {
			...
			return (
				(r.polygons = (t) => r(t).polygons()),
				(r.links = (t) => r(t).links()),
				(r.triangles = (t) => r(t).triangles()),
				(r.x = function (n) {
					return arguments.length
			...
			function N() {
				if (r.apply(this, arguments)) {
					var t = w(this, arguments),
						...
						e = Math.max(
							c[0],
							Math.min(c[1], n.k * 2 ** a.apply(this, arguments)),
						),
						i = Ot(this);
					if (t.wheel)
