import{Bt as e,C as t,J as n,S as r,Tt as i,d as a,i as o,it as s,k as c,r as l,un as u}from"./utils-omhVlsRt.js";import{C as d,t as f,x as p}from"./layers-DHltDypB.js";import{t as m}from"./sum-BpJJqxFM.js";import{t as h}from"./sin-DXK16t1M.js";import{t as g}from"./heightUtils-BfaaFPbS.js";import{r as _}from"./tooltips-BQ3W48fB.js";import{a as v,r as y,t as ee}from"./dialog-helpers-CdcIkxap.js";import{t as b}from"./population-generator-CGI_wUt3.js";import{P as x,b as S,y as C}from"./index-DWZM8gkY.js";import{t as w}from"./highlighting-D_bHr-1Y.js";import{i as T,n as E,r as D,t as O}from"./table-DM0fGDYA.js";var k=`biomesEditor`,A={my:`right top`,at:`right-10 top+10`,of:`svg`,collision:`fit`},j=[],M=[{key:`name`,label:`Biome`,width:`15em`,permanent:!0,sortBy:e=>e.name,sortType:`alpha`},{key:`habitability`,label:`Habitability`,width:`6.5em`,sortBy:e=>e.habitability},{key:`cells`,label:`Cells`,width:`5em`,sortBy:e=>j[e.i]?.cells??0,defaultSort:`desc`},{key:`area`,label:`Area`,width:`7em`,mobileHidden:!0,sortBy:e=>j[e.i]?.area??0},{key:`population`,label:`Population`,width:`6.2em`,mobileHidden:!0,sortBy:e=>{let t=j[e.i];return t?t.rural+t.urban:0}},{key:`actions`,width:`2em`,permanent:!0}],N=E({getData:()=>S(k,pack.biomes.filter(e=>e.i&&!e.removed),M),onUpdate:e=>z(e,j)});function P(){customization||(ee(`#${k}, .stable`),f.show(`biomes`),f.hide(`states`,`cultures`),f.hide(`religions`,`provinces`),F(),j=R(),N.reset(),$(`#${k}`).dialog({title:`Biomes Editor`,resizable:!1,close:ae,position:A}))}function F(){y(k);let e=`<div id="${k}" class="dialog stable editorDialog">
