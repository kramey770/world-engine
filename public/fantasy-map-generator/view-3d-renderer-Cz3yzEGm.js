import{C as e,Ct as t,S as n,Tt as r,Z as i,Zt as a}from"./utils-omhVlsRt.js";import{d as o,t as s}from"./layers-DHltDypB.js";import{t as c}from"./coastline-generator-DoQgut8s.js";import{n as l}from"./platform-BYoBA9Yc.js";import{S as u,h as d}from"./index-DWZM8gkY.js";var f=20,p={freshwater:1,salt:2,sinkhole:3,dry:4,lava:5,frozen:6},m=null;function h(e){let t=2166136261,n=e=>{t^=e&255,t=Math.imul(t,16777619)>>>0},r=e=>{if(e)for(let t=0;t<e.length;t++){let r=e[t];n(r),r>255&&n(r>>8)}},i=[seed,graphWidth,graphHeight,grid.cellsX,grid.cellsY,e.strength,e.riverDepth,e.octaves,e.bakeResolution].join(`|`);for(let e=0;e<i.length;e++)n(i.charCodeAt(e));return r(grid.cells.h),r(pack.cells.r),r(pack.cells.fl),t.toString(36)}function g(e){let t=graphHeight/graphWidth,n=e,r=Math.max(64,Math.round(n*(t<=1?t:1/t)));return t<=1?[n,r]:[r,n]}function _(){let{cellsX:e,cellsY:t}=grid,n=grid.cells.h.length,r=new Uint8Array(n*4),i=Uint8Array.from(grid.cells.h),a=new Float64Array(n),o=new Uint16Array(n);for(let e=0;e<pack.cells.g.length;e++){let t=pack.cells.g[e];a[t]+=pack.cells.h[e],o[t]++}for(let e=0;e<n;e++)o[e]>0&&(i[e]=Math.round(a[e]/o[e]));for(let e=0;e<n;e++){let t=i[e],n=0;if(grid.cells.c[e])for(let r of grid.cells.c[e]){if(i[r]<f)continue;let e=Math.abs(t-i[r]);e>n&&(n=e)}r[e*4]=t,r[e*4+1]=Math.min(n*10,255),r[e*4+3]=255}let s=new THREE.DataTexture(r,e,t,THREE.RGBAFormat,THREE.UnsignedByteType);return s.minFilter=s.magFilter=THREE.LinearFilter,s.needsUpdate=!0,s}function v(e,t){let n=e/graphWidth,r=t/graphHeight,i=e=>e&&e.type!==`ocean`&&e.type!==`lake`,a=document.createElement(`canvas`);a.width=e,a.height=t;let o=a.getContext(`2d`);o.fillStyle=`#000`,o.fillRect(0,0,e,t),o.save(),o.scale(n,r),o.fillStyle=`#fff`;for(let e of pack.features)i(e)&&o.fill(new Path2D(c.getFeaturePath(e)));o.fillStyle=`#000`;for(let e of pack.features)e&&e.type===`lake`&&o.fill(new Path2D(c.getFeaturePath(e)));o.restore();let s=Math.max(1,grid.spacing*.5*n),l=document.createElement(`canvas`);l.width=e,l.height=t;let u=l.getContext(`2d`);u.fillStyle=`#000`,u.fillRect(0,0,e,t),u.save(),u.scale(n,r),u.fillStyle=u.strokeStyle=`#fff`,u.lineJoin=u.lineCap=`round`;let d=1.1/n;for(let e of pack.rivers||[]){if(!e.cells||e.cells.length<2)continue;let t=e.points&&e.points.length===e.cells.length?e.points:null;try{let n=Rivers.addMeandering(e.cells,t);u.fill(new Path2D(Rivers.getRiverPath(n,e.widthFactor,e.sourceWidth)));let r=n[0][2];for(let t=1;t<n.length;t++){n[t][2]>r&&(r=n[t][2]);let i=Rivers.getOffset({flux:r,pointIndex:t,widthFactor:e.widthFactor,startingWidth:e.sourceWidth});u.lineWidth=Math.max(2*i,d),u.beginPath(),u.moveTo(n[t-1][0],n[t-1][1]),u.lineTo(n[t][0],n[t][1]),u.stroke()}}catch{}}u.restore();let m=s*2,h=document.createElement(`canvas`);h.width=e,h.height=t;let g=h.getContext(`2d`);g.fillStyle=`#fff`,g.fillRect(0,0,e,t),g.save(),g.scale(n,r),g.fillStyle=`#000`;for(let e of pack.features)i(e)&&g.fill(new Path2D(c.getFeaturePath(e)));g.strokeStyle=`#fff`,g.lineJoin=`round`,g.lineWidth=m*2/n;for(let e of pack.features){if(!e||e.type===`ocean`)continue;let t=new Path2D(c.getFeaturePath(e));e.type===`lake`&&g.fill(t),g.stroke(t)}g.restore();let _=document.createElement(`canvas`);_.width=e,_.height=t;let v=_.getContext(`2d`);v.drawImage(l,0,0),v.globalCompositeOperation=`multiply`,v.drawImage(h,0,0),o.globalCompositeOperation=`multiply`,o.filter=`invert(1)`,o.drawImage(_,0,0),o.filter=`none`,o.globalCompositeOperation=`source-over`;let y=document.createElement(`canvas`);y.width=e,y.height=t;let b=y.getContext(`2d`);b.filter=`blur(${s}px)`,b.drawImage(a,0,0);let x=document.createElement(`canvas`);x.width=e,x.height=t;let S=x.getContext(`2d`);S.fillStyle=`rgb(${f},${f},${f})`,S.fillRect(0,0,e,t),S.save(),S.scale(n,r),S.lineJoin=`round`;for(let e of pack.features){if(!e||e.type!==`lake`)continue;let t=Math.round(Math.max(e.height||f,f)),r=new Path2D(c.getFeaturePath(e));S.fillStyle=S.strokeStyle=`rgb(${t},${t},${t})`,S.lineWidth=s*6/n,S.fill(r),S.stroke(r)}S.restore();let C=document.createElement(`canvas`);C.width=e,C.height=t;let w=C.getContext(`2d`);w.filter=`blur(${s}px)`,w.drawImage(x,0,0);let ee=document.createElement(`canvas`);ee.width=e,ee.height=t;let T=ee.getContext(`2d`);T.fillStyle=`#000`,T.fillRect(0,0,e,t),T.save(),T.scale(n,r),T.lineJoin=`round`,T.lineWidth=s*6/n;for(let e of pack.features){if(!e||e.type!==`lake`)continue;let t=(p[e.subtype]??1)*40,n=new Path2D(c.getFeaturePath(e));T.fillStyle=T.strokeStyle=`rgb(${t},${t},${t})`,T.fill(n),T.stroke(n)}T.restore();let te=u.getImageData(0,0,e,t).data,ne=b.getImageData(0,0,e,t).data,E=w.getImageData(0,0,e,t).data,re=T.getImageData(0,0,e,t).data,D=new Uint8Array(e*t*4);for(let n=0;n<e*t;n++)D[n*4]=ne[n*4],D[n*4+1]=E[n*4],D[n*4+2]=te[n*4],D[n*4+3]=re[n*4];let O=new THREE.DataTexture(D,e,t,THREE.RGBAFormat,THREE.UnsignedByteType);return O.minFilter=O.magFilter=THREE.LinearFilter,O.needsUpdate=!0,{texture:O,data:D}}function y(e,t){let n=e;for(let e=0;e<t;e++){let e=[n[0]];for(let t=0;t<n.length-1;t++){let r=n[t],i=n[t+1];e.push([r[0]*.75+i[0]*.25,r[1]*.75+i[1]*.25,r[2]*.75+i[2]*.25],[r[0]*.25+i[0]*.75,r[1]*.25+i[1]*.75,r[2]*.25+i[2]*.75])}e.push(n[n.length-1]),n=e}return n}function b(e,t){let n=document.createElement(`canvas`);n.width=Math.max(256,Math.round(e/4)),n.height=Math.max(2,Math.round(n.width*t/e));let r=n.getContext(`2d`);r.fillStyle=`#000`,r.fillRect(0,0,n.width,n.height);let i=()=>{let e=new THREE.CanvasTexture(n);return e.flipY=!1,e.minFilter=e.magFilter=THREE.LinearFilter,e.generateMipmaps=!1,e};if(!pack.rivers?.length||!pack.cells.fl)return i();let a=[1,1,2,3,5,8,13,21,34].map(e=>e/200),o=[];for(let e of pack.rivers){let t=[];for(let n=0;n<e.cells.length;n++){let r=e.cells[n];if(r<0||pack.cells.h[r]<f)continue;let i=Math.min(pack.cells.fl[r]**.7/500,1),o=n/200+(a[n]??.17),s=e.widthFactor*(o+i)+(e.sourceWidth||0);t.push([pack.cells.p[r][0],pack.cells.p[r][1],s])}t.length>1&&o.push(y(t,2))}let s=n.width/graphWidth,c=grid.spacing*.6,l=[{grow:1,gray:255},{grow:2,gray:140},{grow:3.4,gray:70},{grow:5.2,gray:30}];r.lineCap=`round`,r.lineJoin=`round`,r.globalCompositeOperation=`lighten`;for(let{grow:e,gray:t}of l){r.strokeStyle=`rgb(${t},${t},${t})`;for(let t of o)for(let n=0;n<t.length-1;n++){let[i,a,o]=t[n],[l,u,d]=t[n+1],f=c+(o+d)/2*3;r.lineWidth=Math.max(1,f*e*s),r.beginPath(),r.moveTo(i*s,a*s),r.lineTo(l*s,u*s),r.stroke()}}let{fl:u,h:d,c:p,p:m,r:h}=pack.cells;for(let e of pack.cells.i){if(d[e]<f||h[e]||!u[e]||u[e]<20)continue;let t=-1,n=d[e];for(let r of p[e])d[r]<n&&(n=d[r],t=r);if(t===-1)continue;let i=Math.min(u[e]/100,1),a=Math.round(12+28*i);r.strokeStyle=`rgb(${a},${a},${a})`,r.lineWidth=Math.max(1,c*.4*s),r.beginPath(),r.moveTo(m[e][0]*s,m[e][1]*s),r.lineTo(m[t][0]*s,m[t][1]*s),r.stroke()}return i()}var x=`
  ...
  `;function C(e,t,n,r,i){let a=new THREE.WebGLRenderTarget(n,r,{format:THREE.RGBAFormat,type:THREE.UnsignedByteType,minFilter:THREE.NearestFilter,magFilter:THREE.NearestFilter,depthBuffer:!1,stencilBuffer:!1}),o=new THREE.RawShaderMaterial({vertexShader:x,fragmentShader:S,uniforms:{uHeight:{value:i.height},uCoast:{value:i.coast},uRivers:{value:i.rivers},uGridSize:{value:new THREE.Vector2(grid.cellsX,grid.cellsY)},uResolution:{value:new THREE.Vector2(n,r)},uAspect:{value:graphHeight/graphWidth},uSeed:{value:(Number.parseInt(seed,10)%1e5||1)/1e5+1},uStrength:{value:t.strength/50},uRiverDepth:{value:t.riverDepth/100},uOctaves:{value:t.octaves}},depthTest:!1,depthWrite:!1}),s=new THREE.BufferGeometry;s.setAttribute(`position`,new THREE.BufferAttribute(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3));let c=new THREE.Mesh(s,o);c.frustumCulled=!1;let l=new THREE.Scene;l.add(c);let u=new THREE.OrthographicCamera(-1,1,1,-1,0,1),d=e.getRenderTarget();e.setRenderTarget(a),e.render(l,u);let f=new Uint8Array(n*r*4);return e.readRenderTargetPixels(a,0,0,n,r,f),e.setRenderTarget(d),a.dispose(),o.dispose(),s.dispose(),f}function w(e){if(!pack.rivers?.length)return;let{heights:t,pixels:n,coast:r,cols:i,rows:a}=e,o=i/graphWidth,s=a/graphHeight,c=(e,r)=>{if(t[e]<=r)return;t[e]=r;let i=Math.round(r*65535);n[e*4]=i>>8,n[e*4+1]=i&255},l=(e,n,l,u,d)=>{let f=l+Math.min(Math.max(u*150,1.5),10),p=e*o-.5,m=n*s-.5,h=Math.max(Math.ceil(p-f),0),g=Math.min(Math.floor(p+f),i-1),_=Math.max(Math.ceil(m-f),0),v=Math.min(Math.floor(m+f),a-1);for(let e=_;e<=v;e++)for(let n=h;n<=g;n++){let a=Math.hypot(n-p,e-m);if(a>f)continue;let o=e*i+n,s=r[o*4+1]/100,u=Math.max(d,s);if(a>l){let e=(a-l)/(f-l);u+=(t[o]-u)*e*e*(3-2*e)}c(o,u)}};for(let n of pack.rivers){if(!n.cells||n.cells.length<2)continue;let r=n.points&&n.points.length===n.cells.length?n.points:null,i;try{i=Rivers.addMeandering(n.cells,r)}catch{continue}if(i.length<2)continue;let a=n.sourceWidth||0,c=0,u=1/0,[d,f]=i[0],p=a;for(let r=0;r<i.length;r++){let[m,h,g]=i[r];g>c&&(c=g);let _=Rivers.getOffset({flux:c,pointIndex:r,widthFactor:n.widthFactor,startingWidth:a}),v=Math.hypot((m-d)*o,(h-f)*s),y=r===0?1:Math.max(Math.ceil(v/.75),1);for(let n=1;n<=y;n++){let r=n/y,i=d+(m-d)*r,a=f+(h-f)*r,s=T(e,t,i,a);s>u+1e-4?l(i,a,(p+(_-p)*r)*o+1,s-u,u):s<u&&(u=s)}d=m,f=h,p=_}}}async function ee(e,t){let n=h(t);if(m&&m.key===n)return m;try{TIME&&console.time(`erosionBake`);let[r,i]=g(t.bakeResolution),a=v(r,i),o={height:_(),coast:a.texture,rivers:b(r,i)},s=C(e,t,r,i,o);for(let e of Object.values(o))e.dispose();let c=new Float32Array(r*i);for(let e=0,t=0;e<c.length;e++,t+=4)c[e]=(s[t]*256+s[t+1])/65535;let l={key:n,heights:c,pixels:s,coast:a.data,cols:r,rows:i};return t.riverDepth>0&&w(l),m=l,TIME&&console.timeEnd(`erosionBake`),m}catch(e){return console.error(`3D erosion bake failed:`,e),m=null,null}}function T(e,t,n,r){let{cols:i,rows:a}=e,o=Math.min(Math.max(n/graphWidth*i-.5,0),i-1),s=Math.min(Math.max(r/graphHeight*a-.5,0),a-1),c=Math.floor(o),l=Math.floor(s),u=Math.min(c+1,i-1),d=Math.min(l+1,a-1),f=o-c,p=s-l,m=t[l*i+c]*(1-f)+t[l*i+u]*f,h=t[d*i+c]*(1-f)+t[d*i+u]*f;return m*(1-p)+h*p}var te=18,ne=82;function E(e,t,n){return m?(T(m,m.heights,e,t)*100-te)/ne*n:0}function re(e){return e===void 0?!!m:!!(m&&m.key===e)}function D(){m=null}var O=null,ie=[{color:[.24,.58,.71],density:0},{color:[.89,.78,.57],density:.02},{color:[.75,.68,.54],density:.05},{color:[.62,.61,.34],density:.35},{color:[.45,.59,.25],density:.45},{color:[.25,.48,.18],density:.85},{color:[.17,.4,.15],density:.9},{color:[.11,.36,.13],density:1},{color:[.13,.38,.15],density:1},{color:[.15,.3,.18],density:.85},{color:[.6,.57,.46],density:.12},{color:[.93,.95,.97],density:0},{color:[.26,.4,.23],density:.65}];function ae(e,t){let n=ie[t]||ie[0],r=ie[e];if(r)return r;let i=a(pack.biomes[e].color)?.rgb();return i?{color:[i.r/255,i.g/255,i.b/255],density:n.density}:n}function oe(){let{cellsX:e,cellsY:t}=grid,{temp:n,prec:r,h:i,c:a}=grid.cells,o=n.length,s=Float32Array.from(i);for(let e=0;e<3;e++){let e=Float32Array.from(s);for(let t=0;t<o;t++){if(i[t]>=20)continue;let n=s[t],r=1;for(let e of a[t])i[e]<20&&(n+=s[e],r++);e[t]=n/r}s=e}let c=new Uint8Array(o*4);for(let e=0;e<o;e++)c[e*4]=Math.max(0,Math.min(255,n[e]+128)),c[e*4+1]=Math.min(r[e]/30,1)*255,c[e*4+2]=Math.min(i[e]>=20?i[e]:s[e],100)*2.55,c[e*4+3]=255;let l=new THREE.DataTexture(c,e,t,THREE.RGBAFormat,THREE.UnsignedByteType);return l.minFilter=l.magFilter=THREE.LinearFilter,l.needsUpdate=!0,l}function se(){let{cellsX:e,cellsY:t}=grid,{temp:n,prec:r,h:i}=grid.cells,a=n.length,o=new Uint8Array(a),s=new Uint8Array(a),c=pack.cells.g,l=pack.cells.biome;for(let e=0;e<c.length;e++){let t=c[e];s[t]||(o[t]=l[e],s[t]=1)}let u=new Uint8Array(a*4);for(let e=0;e<a;e++){let t=Biomes.getId(r[e]+4,n[e],i[e],!1),{color:a,density:c}=ae(s[e]?o[e]:t,t);u[e*4]=a[0]*255,u[e*4+1]=a[1]*255,u[e*4+2]=a[2]*255,u[e*4+3]=c*255}let d=new THREE.DataTexture(u,e,t,THREE.RGBAFormat,THREE.UnsignedByteType);return d.minFilter=d.magFilter=THREE.LinearFilter,d.needsUpdate=!0,d}var ce=`
  precision highp float;
  attribute vec3 position;
  void main() {
    gl_Position = vec4(position.xy, 0.0, 1.0);
...
`;function ue(e,t,{scale:n,maxOutput:r}){if(!t?.pixels||!t?.coast)return null;de();let i,a,o,s,c,l;try{let{cols:u,rows:d}=t;i=new THREE.DataTexture(t.pixels,u,d,THREE.RGBAFormat,THREE.UnsignedByteType),i.minFilter=i.magFilter=THREE.NearestFilter,i.needsUpdate=!0,a=new THREE.DataTexture(t.coast,u,d,THREE.RGBAFormat,THREE.UnsignedByteType),a.minFilter=a.magFilter=THREE.LinearFilter,a.needsUpdate=!0,o=oe(),s=se();let f=Math.max(u,d),p=Math.min(r,e.capabilities.maxTextureSize,f*2),m=Math.max(p/f,1),h=Math.round(u*m),g=Math.round(d*m),_=e.capabilities.isWebGL2,v=new THREE.WebGLRenderTarget(h,g,{format:THREE.RGBAFormat,type:THREE.UnsignedByteType,generateMipmaps:_,minFilter:_?THREE.LinearMipmapLinearFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,depthBuffer:!1,stencilBuffer:!1});O=v,v.texture.anisotropy=e.capabilities.getMaxAnisotropy();let y=n*100/82;c=new THREE.RawShaderMaterial({vertexShader:ce,fragmentShader:le,uniforms:{uField:{value:i},uCoast:{value:a},uClimate:{value:o},uBiome:{value:s},uResolution:{value:new THREE.Vector2(h,g)},uFieldSize:{value:new THREE.Vector2(u,d)},uGridSize:{value:new THREE.Vector2(grid.cellsX,grid.cellsY)},uSlopeScale:{value:new THREE.Vector2(y/(graphWidth/u),y/(graphHeight/d))},uAspect:{value:graphHeight/graphWidth},uSeed:{value:(Number.parseInt(seed,10)%1e5||1)/1e5+1}},depthTest:!1,depthWrite:!1}),l=new THREE.BufferGeometry,l.setAttribute(`position`,new THREE.BufferAttribute(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3));let b=new THREE.Mesh(l,c);b.frustumCulled=!1;let x=new THREE.Scene;x.add(b);let S=new THREE.OrthographicCamera(-1,1,1,-1,0,1),C=e.getRenderTarget();return e.setRenderTarget(v),e.render(x,S),e.setRenderTarget(C),v.texture}catch(e){return console.error(`Satellite texture generation failed:`,e),de(),null}finally{c?.dispose(),l?.dispose(),i?.dispose(),a?.dispose(),o?.dispose(),s?.dispose()}}function de(){O&&=(O.dispose(),null)}var fe=10,pe=null;function me(){he();let e=1024/Math.max(graphWidth,graphHeight),t=document.createElement(`canvas`);t.width=Math.max(64,Math.round(graphWidth*e)),t.height=Math.max(64,Math.round(graphHeight*e));let n=t.getContext(`2d`);n.fillStyle=`#000`,n.fillRect(0,0,t.width,t.height),n.save(),n.scale(e,e),n.lineJoin=n.lineCap=`round`;let r=Math.PI*2/fe,i=4/e,a=(e,t)=>`rgb(${Math.round(127.5+127.5*Math.sin(e*r))},${Math.round(127.5+127.5*Math.cos(e*r))},${Math.round(40+t*215)})`,o=e=>Math.min(Math.max((e-.6)/2.4,0),1);for(let e of pack.rivers||[]){if(!e.cells||e.cells.length<2)continue;let t=e.points&&e.points.length===e.cells.length?e.points:null;try{let r=Rivers.addMeandering(e.cells,t),s=0,c=r[0][2],l=0;for(let t=1;t<r.length;t++){let[u,d]=r[t-1],[f,p]=r[t],m=Math.hypot(f-u,p-d);if(m<.01)continue;r[t][2]>c&&(c=r[t][2]);let h=Rivers.getOffset({flux:c,pointIndex:t,widthFactor:e.widthFactor,startingWidth:e.sourceWidth});n.lineWidth=Math.max(2*h,i);let g=Math.max(1,Math.ceil(m/(fe/5))),_=m/g;for(let e=0;e<g;e++){let t=e/g,r=(e+1)/g,i=u+(f-u)*t,c=d+(p-d)*t,h=u+(f-u)*r,v=d+(p-d)*r,y=Math.max(0,E(i,c,82)-E(h,v,82))/_;l=Math.max(o(y),l*.55);let b=n.createLinearGradient(i,c,h,v);b.addColorStop(0,a(s+m*t,l)),b.addColorStop(1,a(s+m*r,l)),n.strokeStyle=b,n.beginPath(),n.moveTo(i,c),n.lineTo(h,v),n.stroke()}s+=m}}catch{}}n.restore();let s=new THREE.CanvasTexture(t);return s.minFilter=s.magFilter=THREE.LinearFilter,s.generateMipmaps=!1,pe=s,s}function he(){pe&&=(pe.dispose(),null)}var k,ge=null,A,j,M,N,_e=0,P,F=null,I,L,R,z,ve,B,V,H,U=[],ye=[],W=[],be=new Map,G=!1,xe=null,K=null,Se={value:0},q=document.createElement(`canvas`).getContext(`2d`),Ce=async(e,t=`viewMesh`)=>(options.threeD.isOn=!0,options.threeD.isGlobe=t===`viewGlobe`,options.threeD.isGlobe?ct(e):Je(e)),J=()=>{$e(),j.remove(L),A.setSize(A.domElement.width,A.domElement.height),options.threeD.isGlobe?dt(!0):nt(graphWidth,graphHeight,grid.cellsX,grid.cellsY),Q()},we=()=>{options.threeD.isGlobe?dt():st()},Te=()=>{N&&N.dispose(),cancelAnimationFrame(_e),F&&F.dispose(),I&&I.dispose(),P&&P.dispose(),ve&&ve.dispose(),B&&B.dispose(),D(),de(),he(),gt(),G=!1,xe=null,$e(),A.renderLists.dispose(),A.dispose(),j.remove(L),j.remove(z),j.remove(R),j.remove(V),F=null,options.threeD.isOn=!1},Ee=e=>{if(options.threeD.scale=e,G){J();return}if(!I)return;let t=I.getAttribute(`position`);for(let e=0;e<t.count;e++)t.setZ(e,at(e));I.setAttribute(`position`,t),I.computeVertexNormals(),J()},De=e=>{z&&(options.threeD.sunColor=e,z.color=new k.Color(e),Q())},Y=e=>t(e,512,8192),X=e=>{let t=A?.capabilities?.maxTextureSize;return t?Math.min(Y(e),t):Y(e)},Z=e=>t(.5,Y(e)/1024,8),Oe=e=>{options.threeD.resolutionScale=X(e),options.threeD.resolution=Z(options.threeD.resolutionScale),J()},ke=e=>{R&&(options.threeD.lightness=e,R.intensity=e,Q())},Ae=(e,t,n=options.threeD.sun.z)=>{z&&(options.threeD.sun={x:e,y:t,z:n},z.position.set(e,t,n),Q())},je=e=>{if(!N)return;options.threeD.isGlobe?options.threeD.rotateGlobe=e:options.threeD.rotateMesh=e,N.autoRotateSpeed=e;let t=!N.autoRotate&&!!e,n=N.autoRotate&&!e;N.autoRotate=!!e,t&&$(),n&&cancelAnimationFrame(_e)},Me=()=>{options.threeD.extendedWater?(j.background=null,j.fog=null,j.remove(V)):ot(graphWidth,graphHeight),options.threeD.extendedWater=!options.threeD.extendedWater,J()},Ne=()=>{options.threeD.labels3d=!options.threeD.labels3d,options.threeD.labels3d?Qe().then(()=>we()):($e(),we())},Pe=()=>{options.threeD.subdivide=!options.threeD.subdivide,J()};function Fe(){let e=document.getElementById(`options3dErosion`);e&&(e.checked=options.threeD.erosion);let t=document.getElementById(`options3dErosionSection`);t&&(t.style.display=options.threeD.erosion?`block`:`none`);let n=document.getElementById(`options3dSubdivide`);n&&(n.disabled=options.threeD.erosion)}var Ie=()=>{options.threeD.erosion=!options.threeD.erosion,J()},Le=e=>{options.threeD.erosionStrength=e,J()},Re=e=>{options.threeD.erosionRiverDepth=e,J()},ze=e=>{options.threeD.erosionDetail=e,J()},Be=e=>{options.threeD.erosionOctaves=e,J()},Ve=()=>{options.threeD.satellite=!options.threeD.satellite,J()},He=()=>{options.threeD.wireframe=!options.threeD.wireframe,J()},Ue=(e,t)=>{j&&(options.threeD.skyColor=e,j.background=new k.Color(e),j.fog&&(j.fog.color=new k.Color(e)),options.threeD.waterColor=t,B&&(B.color=new k.Color(t)),Q())},We=e=>{let t=d[e];t&&(Ae(t.sun.x,t.sun.y,t.sun.z),De(t.sunColor),ke(t.lightness),options.threeD.extendedWater&&Ue(t.skyColor,t.waterColor))},Ge=e=>{let t=X(Number(e)*1024);options.threeD.resolutionScale=t,options.threeD.resolution=Z(t),J()},Ke=async()=>{let t=A.domElement.toDataURL(`image/jpeg`),n=document.createElement(`a`);n.download=`${e()}.jpeg`,n.href=t,n.click(),window.tip(l(`Screenshot`),!0,`success`,7e3),window.setTimeout(()=>window.URL.revokeObjectURL(t),5e3)},qe=async()=>{let t=await(await bt()).parse(L);n(t,`${e()}.obj`,`text/plain;charset=UTF-8`)};async function Je(e){if(!await vt())return window.tip(`Cannot load 3d library`,!1,`error`,4e3);j=new k.Scene,R=new k.AmbientLight(13421772,options.threeD.lightness),j.add(R),z=new k.SpotLight(options.threeD.sunColor,.8,2e3,.8,0,0),z.position.set(options.threeD.sun.x,options.threeD.sun.y,options.threeD.sun.z),z.castShadow=!0,z.shadow.mapSize.width=2048,z.shadow.mapSize.height=2048,j.add(z),A=new k.WebGLRenderer({canvas:e,antialias:!0,preserveDrawingBuffer:!0}),A.setSize(e.width,e.height),A.shadowMap.enabled=!0,A.shadowMap.type=k.PCFSoftShadowMap,options.threeD.resolutionScale=X(options.threeD.resolutionScale),options.threeD.resolution=Z(options.threeD.resolutionScale),options.threeD.extendedWater&&ot(graphWidth,graphHeight),nt(graphWidth,graphHeight,grid.cellsX,grid.cellsY),M=new k.PerspectiveCamera(70,e.width/e.height,.1,2e3),M.position.set(0,400,500);let t=await ut(M,e);return t?(N=t,N.target&&N.target.set(0,0,0),N.enableDamping=!0,N.dampingFactor=.05,N.screenSpacePanning=!1,N.minDistance=50,N.maxDistance=1e3,N.minZoom=.05,N.maxZoom=4,N.zoomSpeed=.6,N.panSpeed=1.6,N.enableRotate=!0,N.rotateSpeed=.5,N.maxPolarAngle=Math.PI/2,N.minPolarAngle=0,N.autoRotate=!!options.threeD.rotateMesh,N.autoRotateSpeed=options.threeD.rotateMesh,$(),N.addEventListener(`change`,Q),!0):!1}function Ye(e,t,n){let r=new k.TextureLoader().load(e);r.anisotropy=A.capabilities.getMaxAnisotropy();let i=new k.SpriteMaterial({map:r}),a=new k.Sprite(i);return a.scale.set(t,n,1),a.renderOrder=1,a}async function Xe({text:e,font:t,size:n,color:r,quality:i,letterSpacing:a}){let o=e.split(`|`),s=n*i,c=s*1.25,l=()=>{q.font=`${s}px ${t}`,q.letterSpacing=`${a*i}px`};return l(),q.canvas.width=Math.max(1,...o.map(e=>Math.ceil(q.measureText(e).width))),q.canvas.height=Math.max(1,Math.ceil(c*o.length)),q.clearRect(0,0,q.canvas.width,q.canvas.height),l(),q.fillStyle=r,o.forEach((e,t)=>{q.fillText(e,0,s+c*t)}),Ye(q.canvas.toDataURL(),q.canvas.width/i,q.canvas.height/i)}function Ze(e,t){let n=e-graphWidth/2,r=t-graphHeight/2;return G?[n,E(e,t,options.threeD.scale),r]:!H||!L?[n,0,r]:(H.ray.origin.x=n,H.ray.origin.z=r,[n,H.intersectObject(L)[0].point.y,r])}async function Qe(){H=new k.Raycaster,H.set(new k.Vector3(0,1e3,0),new k.Vector3(0,-1,0));let e={},t={},n={};function r(e){let t=o({name:e.label?.group||e.group||`burg`,type:`burg`}),n=Number.parseFloat(String(t[`font-size`])),r=Number(e?.label?.letterSpacing??t[`letter-spacing`])||0;return{font:String(t[`font-family`]),size:n,color:String(t.fill||`#000`),letterSpacing:r,elevation:Math.max(5,n*.5),iconSize:Math.max(.3,n*.08),iconColor:`#666`,quality:40}}function i(e){let t=o({name:e.label?.group||`state`,type:`state`}),n=Number.parseFloat(String(t[`font-size`])),r=Number(e?.label?.letterSpacing??t[`letter-spacing`])||0;return{text:e.label?.text||e.name,font:String(t[`font-family`]),size:n,color:String(t.fill||`#000`),letterSpacing:r,elevation:20,quality:80}}function a(t,n){if(!e[t]){let r=new k.MeshPhongMaterial({color:n});r.wireframe=options.threeD.wireframe,e[t]=r}return e[t]}function c(e,n){let r=`${e}_${n.toFixed(2)}`;return t[r]||(t[r]=new k.CylinderGeometry(n*2,n*2,n,16,1)),t[r]}function l(e,t){return n[e]||(n[e]=new k.LineBasicMaterial({color:t})),n[e]}for(let e=1;e<pack.burgs.length;e++){let t=pack.burgs[e];if(t.removed)continue;let n=r(t),[i,o,u]=Ze(t.x,t.y);if(s.isOn(`labels`)&&!t.label?.hidden){let e=await Xe({text:t.label?.text??t.name??``,...n});e.position.set(i,o+n.elevation,u),e.size=n.size,U.push(e),j.add(e)}if(s.isOn(`burgIcons`)){let e=c(t.group,n.iconSize),r=a(t.group,n.iconColor),s=new k.Mesh(e,r);s.position.set(i,o,u),ye.push(s),j.add(s);let d=l(t.group,n.iconColor),f=o+n.iconSize/2,p=o+n.elevation-n.size*.5,m=[new k.Vector3(i,f,u),new k.Vector3(i,p,u)],h=new k.BufferGeometry().setFromPoints(m),g=new k.Line(h,d);W.push(g),j.add(g)}}if(s.isOn(`labels`))for(let e=1;e<pack.states.length;e++){let t=pack.states[e];if(t.removed||t.label?.hidden)continue;let[n,r,a]=Ze(t.pole[0],t.pole[1]),o=i(t),s=await Xe(o);s.position.set(n,r+o.elevation,a),s.size=o.size,U.push(s),j.add(s)}mt()}function $e(){if(j){for(let e of U)j.remove(e),e.material.map&&e.material.map.dispose(),e.material.dispose(),e.geometry.dispose();U=[];for(let e of ye)j.remove(e),e.material.dispose(),e.geometry.dispose();ye=[];for(let e of W)j.remove(e),e.material.dispose(),e.geometry.dispose();W=[]}}async function et(){let e=await u.ExportMap.getMapURL(`mesh`,{noLabels:options.threeD.labels3d,noWater:options.threeD.extendedWater,noViewbox:!0,fullMap:!0});return new Promise(t=>{let n=document.createElement(`canvas`),r=n.getContext(`2d`);n.width=options.threeD.resolutionScale,n.height=options.threeD.resolutionScale;let i=new Image;i.src=e,i.onload=()=>{r.drawImage(i,0,0,n.width,n.height),n.toBlob(e=>{let r=window.URL.createObjectURL(e);window.setTimeout(()=>{n.remove(),window.URL.revokeObjectURL(r)},100),t(r)})}})}async function tt(){if(!A)return null;F&&F.dispose();let e=await et();return await new Promise(t=>{F=new k.TextureLoader().load(e,e=>{t(e)},void 0,()=>t(null))}),F&&(F.anisotropy=A.capabilities.getMaxAnisotropy()),F}async function nt(e,t,n,r){if(!j||!A)return;if(gt(),be=new Map,pack.cells?.g&&pack.cells?.i)for(let e of pack.cells.i){let t=pack.cells.g[e];be.has(t)||be.set(t,e)}let i=!(!options.threeD.satellite||options.threeD.isGlobe||options.threeD.wireframe);!options.threeD.wireframe&&!i&&await tt(),P&&P.dispose(),P=new k.MeshLambertMaterial,options.threeD.wireframe?P.wireframe=!0:i||(P.map=F,P.transparent=!0);let a=null;if((options.threeD.erosion||i)&&!options.threeD.isGlobe){let e=options.threeD.erosionDetail>=2048?4096:options.threeD.erosionDetail>512?2048:1024,t=options.threeD.resolutionScale>=8192?8192:options.threeD.resolutionScale>=4096?2048:1024,n=i?Math.max(e,t):e,r=Math.min(A.capabilities.maxTextureSize,8192);a=await ee(A,{strength:options.threeD.erosion?options.threeD.erosionStrength:0,riverDepth:options.threeD.erosion?options.threeD.erosionRiverDepth:0,octaves:options.threeD.erosion?options.threeD.erosionOctaves:1,bakeResolution:Math.min(n,r)}),!a&&options.threeD.erosion&&(console.warn(`3D erosion bake failed, falling back to standard mesh`),window.tip(`Eroded terrain is not supported on this device`,!1,`warn`,4e3),options.threeD.erosion=!1,Fe())}if(G=!!a&&!!options.threeD.erosion,xe=a,i||(de(),he()),I&&I.dispose(),L&&j.remove(L),G){let n=options.threeD.erosionDetail,r=e>=t?n:Math.max(2,Math.round(n*e/t)),i=e>=t?Math.max(2,Math.round(n*t/e)):n;I=new k.PlaneGeometry(e,t,r-1,i-1);let a=I.getAttribute(`position`);for(let n=0;n<a.count;n++){let r=a.getX(n)+e/2,i=t/2-a.getY(n);a.setZ(n,E(r,i,options.threeD.scale))}I.computeVertexNormals(),L=new k.Mesh(I,P)}else{I=new k.PlaneGeometry(e,t,n-1,r-1);let i=I.getAttribute(`position`);for(let e=0;e<i.count;e++)i.setZ(e,at(e));if(I.setAttribute(`position`,i),I.computeVertexNormals(),options.threeD.subdivide){await yt();let e=window.loopSubdivision.modify(I,1,{split:!0,uvSmooth:!1,preserveEdges:!0,flatOnly:!1,maxTriangles:1/0});L=new k.Mesh(e,P)}else L=new k.Mesh(I,P)}if(i){let e=a&&ue(A,a,{scale:options.threeD.scale,maxOutput:Y(options.threeD.resolutionScale)});e?(P.map=e,_t(P,me()),ht()):(P.map=await tt(),P.transparent=!0)}L.rotation.x=-Math.PI/2,L.castShadow=!0,L.receiveShadow=!0,j.add(L),Q(),options.threeD.labels3d&&(await Qe(),Q())}var rt=18,it=82;function at(e){let t=grid.cells.h[e],n=null;if(t<20?n=e:grid.cells.c[e]&&(n=grid.cells.c[e].find(e=>grid.cells.h[e]<20)??null),n!==null){let e=be.get(n);if(e===void 0)return 0;let t=pack.cells.f[e];if(t===void 0)return 0;let r=pack.features[t];return((r.type===`lake`&&r.height?r.height:20)-rt)/it*options.threeD.scale}return(t-rt)/it*options.threeD.scale}function ot(e,t){j&&(j.background=new k.Color(options.threeD.skyColor),ve=new k.PlaneGeometry(e*10,t*10,1),B=new k.MeshBasicMaterial({color:options.threeD.waterColor}),j.fog=new k.Fog(j.background,500,3e3),V=new k.Mesh(ve,B),V.rotation.x=-Math.PI/2,V.position.y-=3,j.add(V))}async function st(){if(!P||!A)return;if(options.threeD.satellite&&xe&&!options.threeD.isGlobe&&!options.threeD.wireframe){let e=ue(A,xe,{scale:options.threeD.scale,maxOutput:Y(options.threeD.resolutionScale)});if(e){P.map=e,Q();return}}F&&F.dispose();let e=await et();window.setTimeout(()=>window.URL.revokeObjectURL(e),4e3),F=new k.TextureLoader().load(e,Q),P.map=F}async function ct(e){if(!await vt())return window.tip(`Cannot load 3d library`,!1,`error`,4e3),!1;j=new k.Scene,j.background=new k.TextureLoader().load(`https://i0.wp.com/azgaar.files.wordpress.com/2019/10/stars-1.png`,Q),A=new k.WebGLRenderer({canvas:e,antialias:!0,preserveDrawingBuffer:!0}),A.setSize(e.width,e.height),options.threeD.resolutionScale=X(options.threeD.resolutionScale),options.threeD.resolution=Z(options.threeD.resolutionScale),P&&P.dispose(),P=new k.MeshBasicMaterial,dt(!0),M=new k.PerspectiveCamera(45,e.width/e.height,.1,1e3),M.translateZ(5);let t=await lt(M,A.domElement);return t?(N=t,N.zoomSpeed=.25,N.minDistance=1.5,N.maxDistance=10,N.autoRotate=!!options.threeD.rotateGlobe,N.autoRotateSpeed=options.threeD.rotateGlobe,N.mouseButtons={LEFT:k.MOUSE.ROTATE,MIDDLE:k.MOUSE.DOLLY,RIGHT:k.MOUSE.PAN},N.screenSpacePanning=!0,N.minPolarAngle=0,N.maxPolarAngle=Math.PI,N.addEventListener(`change`,Q),!0):!1}async function lt(e,t){return k.OrbitControls?new k.OrbitControls(e,t):new Promise(n=>{let r=document.createElement(`script`);r.src=`libs/orbitControls.min.js`,document.head.append(r),r.onload=()=>n(k.OrbitControls?new k.OrbitControls(e,t):!1),r.onerror=()=>n(!1)})}async function ut(e,t){return k.MapControls?new k.MapControls(e,t):new Promise(n=>{let r=document.createElement(`script`);r.src=`libs/mapControls.min.js`,document.head.append(r),r.onload=()=>n(k.MapControls?new k.MapControls(e,t):!1),r.onerror=()=>n(!1)})}async function dt(e){let t=(mapCoordinates.latT??0)>179;options.threeD.resolutionScale=X(options.threeD.resolutionScale);let n=options.threeD.resolutionScale;options.threeD.resolution=Z(n);let i=Math.max(1,Math.round(n/2)),a=r((mapCoordinates.latT??0)/180*i),o=t?a*2:r(graphWidth/graphHeight*a),s=t?0:(90-(mapCoordinates.latN??0))/180*i,c=t?0:o/4,l=document.createElement(`canvas`).getContext(`2d`);if(l.canvas.width=n,l.canvas.height=i,!t){let e=new Image;e.onload=()=>{l.drawImage(e,0,0,n,i)},e.src=`data:image/png;base64,`}let d=new Image;d.onload=()=>{l.drawImage(d,c,s,o,a),F&&F.dispose(),F=new k.CanvasTexture(l.canvas),P.map=F,e&&ft()},d.src=await u.ExportMap.getMapURL(`mesh`,{noScaleBar:!0,fullMap:!0,noVignette:!0})}function ft(){j&&P&&(I=new k.SphereGeometry(1,64,64),L=new k.Mesh(I,P),j.add(L),N?.autoRotate?$():Q())}var pt=i(mt,200);function Q(){A&&j&&M&&(A.render(j,M),pt())}function mt(){if(M)for(let[e,t]of U.entries()){let n=t.position.distanceTo(M.position),r=n<100*t.size&&n>t.size*6;t.visible=r,W[e]&&(W[e].visible=r)}}function $(){_e=requestAnimationFrame($),N?.update&&N.update()}function ht(){if(K)return;let e=t=>{K=requestAnimationFrame(e),Se.value=t/1e3,Q()};K=requestAnimationFrame(e)}function gt(){K&&cancelAnimationFrame(K),K=null}function _t(e,t){e.onBeforeCompile=e=>{e.uniforms.uTime=Se,e.uniforms.uFlow={value:t},e.fragmentShader=`uniform float uTime;
        ...
        `+e.fragmentShader.replace(`#include <map_fragment>`,`#include <map_fragment>
          ...
          diffuseColor.a = 1.0;`)}}function vt(){return k?Promise.resolve(!0):(ge||=new Promise(e=>{let t=document.createElement(`script`);t.src=`libs/three.min.js`,document.head.append(t),t.onload=()=>{k=window.THREE,e(!0)},t.onerror=()=>e(!1)}),ge)}function yt(){return window.loopSubdivision?Promise.resolve(!0):new Promise(e=>{let t=document.createElement(`script`);t.src=`libs/loopsubdivison.min.js`,document.head.append(t),t.onload=()=>e(!0),t.onerror=()=>e(!1)})}function bt(){return k.OBJExporter?new k.OBJExporter:new Promise(e=>{let t=document.createElement(`script`);t.src=`libs/objexporter.min.js?v=1.89.35`,document.head.append(t),t.onload=()=>e(k.OBJExporter?new k.OBJExporter:!1),t.onerror=()=>e(!1)})}export{Ce as create,E as heightAt,re as isCached,J as redraw,qe as saveOBJ,Ke as saveScreenshot,Ue as setColors,ze as setErosionDetail,Be as setErosionOctaves,Re as setErosionRiverDepth,Le as setErosionStrength,ke as setLightness,Ge as setResolution,Oe as setResolutionScale,je as setRotation,Ee as setScale,Ae as setSun,De as setSunColor,We as setTimeOfDay,Te as stop,Pe as toggle3dSubdivision,Ie as toggleErosion,Ne as toggleLabels,Ve as toggleSatellite,Me as toggleSky,He as toggleWireframe,we as update};