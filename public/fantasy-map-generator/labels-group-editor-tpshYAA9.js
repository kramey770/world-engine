import{k as e}from"./utils-omhVlsRt.js";import{d as t,l as n,t as r}from"./layers-DHltDypB.js";import{r as i}from"./tooltips-BQ3W48fB.js";import{n as a,r as o,t as s}from"./dialog-helpers-CdcIkxap.js";import{P as c,c as l,x as u}from"./index-DWZM8gkY.js";function d(){customization||(s(`.stable`),f(),p(),$(`#labelGroupsConfigurator`).dialog({title:`Configure Label Groups`,resizable:!1,maxHeight:Math.max(window.innerHeight-40,300),position:{my:`right top`,at:`right-10 top+10`,of:`svg`,collision:`fit`},close:E,buttons:{Apply:()=>{e(`labelGroupsForm`).requestSubmit()},Add:()=>{e(`labelGroupsBody`).insertAdjacentHTML(`beforeend`,g({name:``,type:`state`,zoom:{min:null,max:null}},!0,0))},Restore:()=>{let t=Labels.getDefaultOptions();e(`labelsResizeOnZoom`).checked=t.resizeOnZoom,e(`labelsShowAll`).checked=t.showAll,p(t.groups)},Cancel:function(){$(this).dialog(`close`)}}}))}function f(){o(`labelGroupsConfigurator`);let t=`<div id="labelGroupsConfigurator" class="dialog stable">
