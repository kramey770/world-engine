import{A as e,Et as t,X as n,bt as r,c as i,d as a,dn as o,gn as s,i as c,k as l,r as u,wn as d}from"./utils-BIleyWmR.js";import{t as f}from"./layers-qPZxwHcp.js";import{t as p}from"./mean-4Awewi9R.js";import{t as m}from"./drag-Ck8KuEBm.js";import{r as h}from"./tooltips-zkair8Am.js";import{t as g}from"./coastline-generator-B-Fw7qqg.js";import{r as _,t as v}from"./dialog-helpers-50LJgx0U.js";import{P as y,j as b}from"./index-tuMZPduM.js";import{t as x}from"./graph-override-DB5KiD8a.js";function S(e){for(var t=-1,n=e.length,r=e[n-1],i,a,o=r[0],s=r[1],c=0;++t<n;)i=o,a=s,r=e[t],o=r[0],s=r[1],i-=o,a-=s,c+=Math.hypot(i,a);return c}var C;function w(e){customization||(v(`.stable`),f.hide(`cells`),T(),o(`#debug`).append(`g`).attr(`id`,`vertices`),C=o(e),D(),I(),O(),o(`#viewbox`).on(`touchmove mousemove`,null),$(`#lakeEditor`).dialog({title:`Edit Lake`,resizable:!1,position:{my:`center top+20`,at:`top`,of:`svg`,collision:`fit`},close:U}))}function T(){_(`lakeEditor`),l(`dialogs`).insertAdjacentHTML(`beforeend`,`<div id="lakeEditor" class="dialog">
