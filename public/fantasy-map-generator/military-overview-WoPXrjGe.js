import{C as e,Et as t,Kt as n,L as r,N as i,Q as a,S as o,d as s,dn as c,k as l}from"./utils-BXw8fBj4.js";import{t as u}from"./layers-_nptVsMl.js";import{t as d}from"./sum-BpJJqxFM.js";import{r as f}from"./tooltips-0xeyl30m.js";import{a as p,t as m}from"./dialog-helpers-DT2MP2B1.js";import{P as h,b as g,y as _}from"./index-CHSGsxIV.js";import{t as v}from"./highlighting-DTBMtNB_.js";import{i as y,n as b,r as x,t as S}from"./table-CN7n7WQR.js";var C=`militaryOverview`,w={my:`right top`,at:`right-10 top+10`,of:`svg`,collision:`fit`},T=[],E=b({getData:P,onUpdate:I});function D(){customization||(m(`#militaryOverview, .stable`),u.show(`states`,`borders`,`military`),O(),E.reset(),$(`#militaryOverview`).dialog({title:`Military Overview`,resizable:!1,width:fitContent(),close:k,position:w}))}function O(){T=j(),document.getElementById(`militaryOverview`)?.remove();let e=`<div id="${C}" class="dialog stable editorDialog">
