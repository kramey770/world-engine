import{C as e,Et as t,J as n,S as r,Vt as i,at as a,d as o,dn as s,i as c,k as l,r as u}from"./utils-BIleyWmR.js";import{C as d,t as f,x as p}from"./layers-qPZxwHcp.js";import{t as m}from"./sum-BpJJqxFM.js";import{t as h}from"./sin-DXK16t1M.js";import{t as g}from"./heightUtils-BfaaFPbS.js";import{r as _}from"./tooltips-zkair8Am.js";import{a as v,r as y,t as ee}from"./dialog-helpers-50LJgx0U.js";import{t as b}from"./population-generator-BxaLS3uM.js";import{P as x,b as S,y as C}from"./index-tuMZPduM.js";import{t as w}from"./highlighting-CqamXa3p.js";import{i as T,n as E,r as D,t as O}from"./table-oyVozzWP.js";var k=`biomesEditor`,A={my:`right top`,at:`right-10 top+10`,of:`svg`,collision:`fit`},j=[],M=[{key:`name`,label:`Biome`,width:`15em`,permanent:!0,sortBy:e=>e.name,sortType:`alpha`},{key:`habitability`,label:`Habitability`,width:`6.5em`,sortBy:e=>e.habitability},{key:`cells`,label:`Cells`,width:`5em`,sortBy:e=>j[e.i]?.cells??0,defaultSort:`desc`},{key:`area`,label:`Area`,width:`7em`,mobileHidden:!0,sortBy:e=>j[e.i]?.area??0},{key:`population`,label:`Population`,width:`6.2em`,mobileHidden:!0,sortBy:e=>{let t=j[e.i];return t?t.rural+t.urban:0}},{key:`actions`,width:`2em`,permanent:!0}],N=E({getData:()=>S(k,pack.biomes.filter(e=>e.i&&!e.removed),M),onUpdate:e=>z(e,j)});function P(){customization||(ee(`#${k}, .stable`),f.show(`biomes`),f.hide(`states`,`cultures`),f.hide(`religions`,`provinces`),F(),j=R(),N.reset(),$(`#${k}`).dialog({title:`Biomes Editor`,resizable:!1,close:ae,position:A}))}function F(){y(k);let e=`<div id="${k}" class="dialog stable editorDialog">
