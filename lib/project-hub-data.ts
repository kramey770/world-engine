...
export const projectHubData: ProjectHubData = {
  ...
  creation: {
    characters: [
      { id: "darrow", title: "Darrow of Lykos", eyebrow: "Gold infiltrator", summary: "The Red Reaper learns to lead a war he was never meant to survive.", detail: "Helldiver · insurgent · lancer", image: "/red-rising/Darrow%20o%27%20Lykos.png", focus: ["ray", "storyline-c"], destination: destination("Open character", "Character") },
      { id: "virginia", title: "Virginia au Augustus", eyebrow: "Sovereign strategist", summary: "A mind built for the long game, carrying the cost of every alliance.", image: "/red-rising/Virginia%20au%20Augustus.PNG", focus: ["orion", "storyline-d"], destination: destination("Open character", "Character") },
      { id: "sevro", title: "Sevro au Barca", eyebrow: "Howler commander", summary: "A feral loyalty that turns survival into chosen family.", image: "/red-rising/Sevro.PNG", focus: ["orion", "storyline-d"], destination: destination("Open character", "Character") },
    ],
    heraldry: [{ id: "andromedus", title: "House au Andromedus", eyebrow: "Completed crest", summary: "A split sun over a black field, marked by a silver thorn.", image: "/armoria/preview.png", focus: ["ray", "storyline-c"], destination: destination("Open heraldry", "Heraldry") }],
    maps: [{ id: "institute", title: "The Institute Grounds", eyebrow: "Living map fragment", summary: "Frozen valleys, contested gates, and the route toward Olympus.", focus: ["ray", "orion"], destination: destination("Open map", "Map") }],
    collections: [
      { id: "cover", title: "Red Rising", eyebrow: "Book cover", summary: "Caste, rebellion, empire.", image: "/red-rising/Darrow%20o%27%20Lykos.png", focus: ["ray"], destination: destination("Open book cover", "Book Cover") },
      { id: "lineage", title: "The Augustus Line", eyebrow: "Family tree", summary: "Power travels through blood, marriage, and memory.", image: "/families/ravenshollow-banner.png", focus: ["orion", "storyline-d"], destination: destination("Open family tree", "Family Tree") },
    ],
  },
  world: {
    locations: [{ id: "luna", title: "Luna", eyebrow: "Society capital", summary: "A glittering center where every celebration hides a negotiation.", focus: ["orion", "storyline-d"], destination: destination("Open location", "Map") }],
    entities: [
      { id: "sons", title: "Sons of Ares", eyebrow: "Revolutionary network", summary: "An underground constellation of cells, debts, and impossible hope.", focus: ["ray", "storyline-c"], destination: destination("Open canon", "Canon Lore") },
      { id: "society", title: "The Society", eyebrow: "Solar empire", summary: "A caste machine that turns hierarchy into daily ritual.", focus: ["orion"], destination: destination("Open canon", "Canon Lore") },
      { id: "obsidian", title: "Obsidian", eyebrow: "Species / culture", summary: "A people shaped by cold, distance, and inherited duty.", focus: ["storyline-d"], destination: destination("Open canon", "Canon Lore") },
    ],
    relationships: [{ id: "darrow-sevro", title: "Darrow ↔ Sevro", eyebrow: "Uneasy alliance", summary: "Trust forged under pressure", detail: "Weight 92 · Active · Mutual", focus: ["ray", "storyline-c"], destination: destination("Open relationships", "Canon Lore") }],
    timeline: [
      { id: "mines", title: "Life in the mines", eyebrow: "Before the Rising", summary: "The old world teaches obedience before it teaches names.", focus: ["ray"] },
      { id: "institute-era", title: "The Institute", eyebrow: "The rising begins", summary: "A school becomes a battlefield, then a rehearsal for revolution.", focus: ["ray", "orion"] },
      { id: "rising", title: "The Rising", eyebrow: "The turning point", summary: "The oppressed Colors begin to move as one.", focus: ["storyline-c", "storyline-d"] },
    ],
  },
  writing: {
    chapters: [{ id: "chapter-one", title: "Chapter One — The Institute", eyebrow: "2nd Draft · 27% complete", summary: "Darrow enters a landscape built to reward speed, calculation, and the appearance of certainty.", detail: "The first lesson is not announced: every student is already deciding who can be used, who can be trusted, and who must be removed.", metadata: ["The Institute", "Third Limited", "Ominous"], progress: 27, body: "The gates opened without ceremony. Beyond them, the valley lay pale beneath the morning frost, its ridges cut into clean planes of white and blue. Darrow stood with the other students and watched the standards lift along the wall. They were not banners so much as declarations: each one named a house, a debt, a history that had already decided what its bearer was worth.\n\nNo one spoke. That silence was the first test. The students measured one another by posture, by the hands resting near weapons, by the distance each person kept from the next. Darrow felt the old instinct to find the safest edge of a room, then remembered that there was no edge here. The Institute had been built to make shelter look like weakness.\n\nSomewhere beyond the ridge, a horn sounded once. The crowd began to move, and with it the first shape of the war.", focus: ["ray", "orion"], destination: destination("Open writing", "Writing Studio") }],
    sceneBeats: [
      { id: "beat-01", title: "Enter chamber", eyebrow: "01", summary: "The doors close behind him.", metadata: ["The Institute", "Third Limited"], focus: ["ray"] },
      { id: "beat-02", title: "Discover the map", eyebrow: "02", summary: "Every route has already been claimed.", metadata: ["Reversal", "Pressure rises"], focus: ["ray", "orion"] },
      { id: "beat-03", title: "Darius arrives", eyebrow: "03", summary: "A rival offers the wrong kind of smile.", metadata: ["Darius", "Threat"], focus: ["orion"] },
      { id: "beat-04", title: "Confrontation", eyebrow: "04", summary: "The room chooses its side.", metadata: ["Choice", "Public"], focus: ["storyline-c"] },
      { id: "beat-05", title: "Escape", eyebrow: "05", summary: "The first alliance costs blood.", metadata: ["Turn", "Alliance"], focus: ["storyline-d"] },
    ],
    drafts: [
