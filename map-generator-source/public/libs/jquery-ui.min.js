	...
	(t.cleanData = ((e) => (i) => {
		...
		(t.widget = (e, i, s) => {
			...
			return (
				...
				(t.expr[":"][h.toLowerCase()] = (e) => !!t.data(e, h)),
				(t[l] = t[l] || {}),
				(n = t[l][e]),
				(o = t[l][e] =
					function (t, e) {
		...
		t.widget("ui.resizable", t.ui.mouse, {
			...
			_updateVirtualBoundaries: function (t) {
				...
				(o = {
					...
					maxHeight: a.maxHeight ? a.maxHeight : 1 / 0,
				}),
					(this._aspectRatio || t) &&
		...
		t.widget("ui.dialog", {
			...
			_createTitlebar: function () {
				...
				(this.uiDialogTitlebar = t("<div>")),
					...
					(this.uiDialogTitlebarCollapse = t(
						"<button data-tip='Minimize / maximize' type='button'>_</button>",
					...
					this._on(this.uiDialogTitlebarCollapse, {
						click: function (t) {
							t.preventDefault(), $(this.element[0]).toggle();
						},
					}),
					(this.uiDialogTitlebarClose = t(
						"<button data-tip='Close' type='button'>✕</button>",
					).appendTo(this.uiDialogTitlebar)),
					this._addClass(
