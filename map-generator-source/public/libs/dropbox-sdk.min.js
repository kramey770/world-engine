!((e, t) => {
	"object" == typeof exports && "undefined" != typeof module
		...
		: "function" == typeof define && define.amd
			...
			: t(
					((e =
						"undefined" != typeof globalThis ? globalThis : e || self).Dropbox =
						{}),
				);
})(this, (e) => {
	function t(e, t) {
	...
	function n(e, t) {
		return (n = Object.setPrototypeOf || ((e, t) => ((e.__proto__ = t), e)))(
			e,
			t,
		);
	}
				...
				s(e, [
					...
					},
					{
						...
						value: function () {
							...
							if (C())
								return L.subtle.digest("SHA-256", r).then((r) => {
									var s = btoa(
										String.fromCharCode.apply(null, new Uint8Array(r)),
									);
									(e = S(s).substr(0, 128)), (this.codeChallenge = e);
								});
							var s = L.createHash("sha256").update(r).digest();
							return (e = S(s)), (this.codeChallenge = e), Promise.resolve();
						},
					},
					{
								...
								o
									? this.generatePKCECodes().then(
											() => (
												...
												(r += "&code_challenge=".concat(this.codeChallenge))
											),
										)
									: Promise.resolve(r)
							);
						...
						value: function () {
							...
							return (
								...
								this.fetch(r, u)
									.then((e) => F(e))
									.then((t) => {
										this.setAccessToken(t.result.access_token),
											this.setAccessTokenExpiresAt(y(t.result.expires_in));
									})
							);
						},
					},
	...
	(e.Dropbox = (() => {
		function e(r) {
			t(this, e),
				(this.auth = (r = r || {}).auth ? r.auth : new E(r)),
					...
					value: function (e, t, r, s, i) {
						if (r.split(",").length > 1) {
							...
							n.includes(l) && this.auth.getAccessToken()
								? (r = l)
								: n.includes(f) && this.auth.getAccessToken()
									? (r = f)
									: n.includes(p) && (r = p);
						}
						switch (i) {
							...
							.then(() => {
								...
								switch (
									...
									case p:
										...
										(e = V(
											""
												.concat(this.auth.clientId, ":")
												.concat(this.auth.clientSecret),
										)),
								...
								return this.setCommonHeaders(s), s;
							})
							.then((t) =>
								this.fetch(g(s, this.domain, this.domainDelimiter) + e, t),
							)
							.then((e) => F(e));
					},
				},
				{
					...
					value: function (e, t, r, s) {
						return this.auth
							.checkAndRefreshAccessToken()
							.then(() => {
								if (r !== l) throw Error("Unexpected auth type: ".concat(r));
								var e = {
									method: "POST",
									headers: {
										Authorization: "Bearer ".concat(this.auth.getAccessToken()),
										"Dropbox-API-Arg": k(t),
									},
								};
								return this.setCommonHeaders(e), e;
							})
							.then((t) =>
								this.fetch(g(s, this.domain, this.domainDelimiter) + e, t),
							)
