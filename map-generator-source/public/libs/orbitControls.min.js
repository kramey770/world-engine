	...
	class o extends THREE.EventDispatcher {
		constructor(o, a) {
			super(),
				...
				(this.getPolarAngle = () => l.phi),
				(this.getAzimuthalAngle = () => l.theta),
				(this.getDistance = function () {
					return this.object.position.distanceTo(this.target);
				}),
				(this.listenToKeyEvents = function (e) {
					e.addEventListener("keydown", F), (this._domElementKeyEvents = e);
				}),
				(this.saveState = () => {
				...
				(this.update = (() => {
					...
					return function o() {
						...
						t.copy($).sub(i.target),
							...
							i.autoRotate &&
								s === r.NONE &&
								A(((2 * Math.PI) / 60 / 60) * i.autoRotateSpeed),
							i.enableDamping
						...
						return (
							isFinite(g) &&
								...
								g <= O
									? (l.theta = Math.max(g, Math.min(O, l.theta)))
									: (l.theta =
											l.theta > (g + O) / 2
												? Math.max(g, l.theta)
												: Math.min(O, l.theta))),
							...
							!0 === i.enableDamping
								...
								: (m.set(0, 0, 0), u.set(0, 0, 0)),
							(p = 1),
							!!(
								d ||
								h.distanceToSquared(i.object.position) > c ||
								8 * (1 - b.dot(i.object.quaternion)) > c
							) &&
								(i.dispatchEvent(e),
								h.copy(i.object.position),
								b.copy(i.object.quaternion),
								(d = !1),
								!0)
						);
					};
				...
				(this.dispose = () => {
					i.domElement.removeEventListener("contextmenu", K),
						...
						null !== i._domElementKeyEvents &&
							i._domElementKeyEvents.removeEventListener("keydown", F);
				});
			let i = this,
				r = {
					NONE: -1,
				...
				w = (() => {
					...
					return function t(n, o) {
						!0 === i.screenSpacePanning
							...
							: (e.setFromMatrixColumn(o, 0), e.crossVectors(i.object.up, e)),
							e.multiplyScalar(n),
							u.add(e);
					};
				})(),
					...
					return function t(n, o) {
						...
						if (i.object.isPerspectiveCamera) {
							...
							N(
								...
								w((2 * o * s) / a.clientHeight, i.object.matrix);
						} else
							i.object.isOrthographicCamera
								? (N(
										(n * (i.object.right - i.object.left)) /
											i.object.zoom /
											a.clientWidth,
										i.object.matrix,
									),
									w(
										(o * (i.object.top - i.object.bottom)) /
											i.object.zoom /
											a.clientHeight,
										i.object.matrix,
									))
			...
			function x() {
				if (1 === y.length) $.set(y[0].pageX, y[0].pageY);
				else {
					const e = 0.5 * (y[0].pageX + y[1].pageX),
						t = 0.5 * (y[0].pageY + y[1].pageY);
					$.set(e, t);
			...
			function D(e) {
				...
				E.subVectors(b, h).multiplyScalar(i.rotateSpeed);
				const a = i.domElement;
				A((2 * Math.PI * E.x) / a.clientHeight),
					L((2 * Math.PI * E.y) / a.clientHeight),
					h.copy(b);
			}
			function I(e) {
				if (1 === y.length) g.set(e.pageX, e.pageY);
				else {
					const t = W(e),
						n = 0.5 * (e.pageX + t.x),
						o = 0.5 * (e.pageY + t.y);
				...
				O.subVectors(g, $).multiplyScalar(i.panSpeed), j(O.x, O.y), $.copy(g);
			}
			function U(e) {
				const t = W(e),
					n = e.pageX - t.x,
					o = e.pageY - t.y;
				T.set(0, Math.sqrt(n * n + o * o)),
					_.set(0, (T.y / f.y) ** i.zoomSpeed),
					R(_.y),
					f.copy(T);
			}
			function V(e) {
				...
				!1 !== i.enabled &&
					(0 === y.length &&
						...
						i.domElement.addEventListener("pointermove", z),
						...
						: (function e(n) {
								...
								switch (o) {
									case THREE.MOUSE.DOLLY: {
										...
										(a = n), f.set(a.clientX, a.clientY), (s = r.DOLLY);
										break;
									}
									...
									switch (s) {
										case r.ROTATE:
											...
											!(function e(t) {
												...
												A((2 * Math.PI * E.x) / n.clientHeight),
													L((2 * Math.PI * E.y) / n.clientHeight),
													h.copy(b),
													i.update();
											})(t);
											break;
										...
										case r.PAN:
											...
											(o = t),
												...
												O.subVectors(g, $).multiplyScalar(i.panSpeed),
												j(O.x, O.y),
												$.copy(g),
												i.update();
									}
			...
			function M(e) {
				if (!1 !== i.enabled && !1 !== i.enableZoom && s === r.NONE) {
					var o;
					e.preventDefault(),
						i.dispatchEvent(t),
						(o = e).deltaY < 0 ? S(v()) : o.deltaY > 0 && R(v()),
						i.update(),
						i.dispatchEvent(n);
				}
			}
			function F(e) {
				!1 !== i.enabled &&
					...
					(function e(t) {
						...
						switch (t.code) {
							case i.keys.UP:
								j(0, i.keyPanSpeed), (n = !0);
								break;
							case i.keys.BOTTOM:
								j(0, -i.keyPanSpeed), (n = !0);
								break;
							case i.keys.LEFT:
								j(i.keyPanSpeed, 0), (n = !0);
								break;
							case i.keys.RIGHT:
								j(-i.keyPanSpeed, 0), (n = !0);
						}
						n && (t.preventDefault(), i.update());
					})(e);
			}
			function K(e) {
			...
			i.domElement.addEventListener("contextmenu", K),
				i.domElement.addEventListener("pointerdown", V),
				i.domElement.addEventListener("pointercancel", Z),
				i.domElement.addEventListener("wheel", M, { passive: !1 }),
				this.update();
		}
	}
