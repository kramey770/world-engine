...
function getElement(
	...
	const element = ensureEl<HTMLElement>(
		`marker${markerI}`,
...
function updateInputs(): void {
	...
	ensureEl<HTMLInputElement>("markerIconShiftX").value = String(
		marker.dx || 50,
	);
	ensureEl<HTMLInputElement>("markerIconShiftY").value = String(
		marker.dy || 50,
	);
