...
function renderDialog(): void {
	...
	ensureEl("namesbaseName").addEventListener("input", (e) =>
		updateBaseName((e.target as HTMLInputElement).value),
	);
	ensureEl("namesbaseMin").addEventListener("input", (e) =>
		updateBaseMin((e.target as HTMLInputElement).value),
	);
	ensureEl("namesbaseMax").addEventListener("input", (e) =>
	...
	ensureEl("namesbaseDefault").addEventListener(
		"click",
		namesbaseRestoreDefault,
	);
	...
	ensureEl("namesbaseSpeak").addEventListener("click", () =>
...
function updateInputs(): void {
	...
	(ensureEl("namesbaseTextarea") as HTMLTextAreaElement).value =
		Names.nameBases[base].b;
	(ensureEl("namesbaseName") as HTMLInputElement).value =
		Names.nameBases[base].name;
	(ensureEl("namesbaseMin") as HTMLInputElement).value = String(
		Names.nameBases[base].min,
	);
	(ensureEl("namesbaseMax") as HTMLInputElement).value = String(
		Names.nameBases[base].max,
	);
	(ensureEl("namesbaseDouble") as HTMLInputElement).value =
		Names.nameBases[base].d;
	updateExamples();
}
