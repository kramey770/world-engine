...
describe("label spread path candidates", () => {
	test("clamps candidate offsets to 20–80 while retaining an in-range current offset", () => {
		expect(getPathStartOffsetCandidates(10)).toEqual([
			20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75, 80,
		]);
		expect(getPathStartOffsetCandidates(40)).toEqual([
			40, 20, 25, 30, 35, 45, 50, 55, 60, 65, 70, 75, 80,
		]);
		expect(getPathStartOffsetCandidates(90)).toEqual([
