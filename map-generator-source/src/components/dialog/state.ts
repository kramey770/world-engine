...
function restoreValue<Value extends JsonValue>(
	...
	if (Array.isArray(fallback))
		return (Array.isArray(stored) ? stored : fallback) as Value;
	if (!isRecord(fallback))
		return (typeof stored === typeof fallback ? stored : fallback) as Value;
