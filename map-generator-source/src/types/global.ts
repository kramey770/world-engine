...
declare global {
	...
	var drawRoutes: () => void;
	var drawRoute: (
		route: import("../generators/routes-generator").Route,
	) => void;
	...
	var routeTypeStyle: (type: string) =>
		| {
				"stroke-width": number;
		...
		| undefined;
	var routeGroupStyle: (group: string) =>
		| {
				"stroke-width": number;
				"stroke-dasharray": string | null;
				"stroke-linecap": string;
