...
class HeightmapModule {
	...
	addHill(count: string, height: string, rangeX: string, rangeY: string): void {
		...
		const scaledCount = Math.round(
			baseCount * countScale(baseCount, this.grid.cellsDesired),
		);
	...
	addPit(count: string, height: string, rangeX: string, rangeY: string): void {
		...
		const desiredPitCount = Math.round(
			basePitCount * countScale(basePitCount, this.grid.cellsDesired),
		);
	...
	addRange(
		...
		const desiredRangeCount = Math.round(
			baseRangeCount * countScale(baseRangeCount, this.grid.cellsDesired),
		);
	...
	addTrough(
		...
		const desiredTroughCount = Math.round(
			baseTroughCount * countScale(baseTroughCount, this.grid.cellsDesired),
		);
