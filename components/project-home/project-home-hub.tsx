...
function gridPlacementFor(id: string): { column: string; row: string } {
  const placements: Record<string, { column: string; row: string }> = {
    "creation-anchor": { column: "1 / span 3", row: "1 / span 2" },
    "creation-spotlight": { column: "4 / span 5", row: "1 / span 4" },
    "character-showcase": { column: "9 / span 4", row: "1 / span 5" },
    "map-showcase": { column: "1 / span 3", row: "3 / span 4" },
    "creation-collection": { column: "4 / span 5", row: "5 / span 4" },
    "heraldry-showcase": { column: "9 / span 4", row: "6 / span 3" },
    "creation-pulse": { column: "1 / span 3", row: "7 / span 2" },
    "world-anchor": { column: "1 / span 2", row: "9 / span 2" },
    "world-spotlight": { column: "3 / span 5", row: "9 / span 3" },
    "relationships": { column: "8 / span 5", row: "9 / span 2" },
    "location-window": { column: "1 / span 2", row: "11 / span 4" },
    ...
    "writing-profile": { column: "8 / span 3", row: "18 / span 5" },
    "writing-pulse": { column: "11 / span 2", row: "18 / span 5" },
  }
