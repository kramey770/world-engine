    ...
    <HubBox definition={definition} onOpen={onOpen}>
      <div className="flex h-full min-h-40 flex-col">
        <div className="flex items-start justify-between">
          ...
          <HeartHandshake className="size-5 text-amber-200/75" />
        </div>

        <div className="relative mt-5 flex flex-1 items-center justify-between gap-3 text-center">
          <div className="relative flex-1">
            <div className="mx-auto flex size-14 items-center justify-center rounded-full border border-sky-200/40 bg-sky-200/10 font-serif text-lg text-sky-100">A</div>
            <p className="mt-2 text-xs text-white/75">Entity A</p>
            <p className="mt-1 text-[9px] uppercase tracking-[0.14em] text-white/40">Subject</p>
          </div>
        ...
        <div className="mt-3 flex items-center justify-between gap-3 border-t border-white/10 pt-3 text-[10px] uppercase tracking-[0.14em] text-white/45">
          <span className="flex items-center gap-1.5"><ShieldAlert className="size-3 text-amber-200" /> Relationship</span>
          <span className="flex items-center gap-1.5"><Sparkles className="size-3" /> Pending</span>
        </div>
      </div>
    </HubBox>
  )
