    ...
    <HubBox definition={definition} onOpen={onOpen}>
      <div className="flex h-full min-h-40 flex-col">
        ...
        <div className="relative mt-5 flex flex-1 items-center justify-between gap-3 text-center">
          ...
          <div className="relative flex-1"><div className="mx-auto flex size-14 items-center justify-center rounded-full border border-rose-200/40 bg-rose-200/10 font-serif text-lg text-rose-100">B</div><p className="mt-2 text-xs text-current/75">Entity B</p><p className="mt-1 text-[9px] uppercase tracking-[0.14em] text-current/40">Object</p></div>
        </div>
        <div className="mt-3 flex items-center justify-between gap-3 border-t border-current/10 pt-3 text-[10px] uppercase tracking-[0.14em] text-current/45"><span className="flex items-center gap-1.5"><ShieldAlert className="size-3 text-amber-200" /> Relationship pending</span><span className="flex items-center gap-1.5"><Sparkles className="size-3" /> Details pending</span></div>
