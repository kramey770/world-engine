    ...
    <HubBox definition={definition} onOpen={onOpen}>
      <div className="flex h-full min-h-40 flex-col">
        ...
        <div className="relative mt-4 flex min-h-20 flex-1 items-end overflow-hidden border border-sky-200/15 bg-[#0b2028]">
          ...
          <div className="relative flex w-full items-center justify-between px-3 pb-2 text-[9px] uppercase tracking-[0.15em] text-white/55"><span className="flex items-center gap-1"><Mountain className="size-3" /> Region pending</span><span className="flex items-center gap-1"><Waves className="size-3" /> Geography pending</span></div>
        </div>
