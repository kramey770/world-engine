  ...
  return (
    <HubBox definition={definition} onOpen={onOpen}>
      <div className="flex h-full min-h-40 flex-col items-center text-center">
        ...
        <div className="relative mt-5 flex size-28 items-center justify-center overflow-hidden [clip-path:polygon(50%_0,88%_18%,82%_72%,50%_100%,18%_72%,12%_18%)] bg-gradient-to-br from-emerald-100/80 via-emerald-700 to-[#09221f] shadow-[0_0_35px_rgba(110,231,183,.2)]">
